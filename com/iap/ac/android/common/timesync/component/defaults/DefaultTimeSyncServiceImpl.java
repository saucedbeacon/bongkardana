...
public class DefaultTimeSyncServiceImpl implements ITimeSyncService {
    private static final String SHARED_PREFERENCES_NAME = "ac_time_sp";
        ...
        IAPAsyncTask.asyncTask((Runnable) new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    ACLog.i(access$000, sb.toString());
                    ...
                    ACLog.e(access$0002, sb2.toString());
    ...
    public void setServerTime(long j, long j2) {
        ACLog.i(TAG, String.format(Locale.getDefault(), "set serverTime = %d, requestCostTime = %d", new Object[]{Long.valueOf(j2), Long.valueOf(j)}));
    ...
    public long getServerTime() {
        ...
        ACLog.i(TAG, String.format(Locale.getDefault(), "get serverTime = %d, localTime = %d", new Object[]{Long.valueOf(j), Long.valueOf(currentTimeMillis)}));
        return j;
    }
    ...
    public long getLastSyncTime() {
        ...
        ACLog.i(TAG, String.format(Locale.getDefault(), "get lastSyncTime = %d", new Object[]{Long.valueOf(this.mLastSyncTime)}));
