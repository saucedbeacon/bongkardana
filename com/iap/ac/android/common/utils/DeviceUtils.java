...
public class DeviceUtils {
        ...
        if (sClientKey == null) {
            if (TextUtils.isEmpty(str) || context == null) {
                ...
                try {
                    ...
                    sb2.append(digest.length * 2);
                    sb2.append("X");
                    sClientKey = String.format(sb2.toString(), new Object[]{new BigInteger(1, digest)});
                } catch (NoSuchAlgorithmException e) {
                    ACLog.e(TAG, "can not generate terminal identifier cause of sha-256 algorithm not found.", e);
                }
            }
    ...
    private static int getCoresFromFileInfo(java.lang.String r2) {
        ...
        L_0x002e:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iap.ac.android.common.utils.DeviceUtils.getCoresFromFileInfo(java.lang.String):int");
    }
    ...
    public static int getNumberOfCPUCores() {
        ...
        L_0x0006:
            ...
            java.lang.Class<com.iap.ac.android.common.utils.DeviceUtils> r0 = com.iap.ac.android.common.utils.DeviceUtils.class
            monitor-enter(r0)
        ...
        L_0x003c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.iap.ac.android.common.utils.DeviceUtils.getNumberOfCPUCores():int");
    }
}
