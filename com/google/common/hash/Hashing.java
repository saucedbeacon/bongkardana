...
public final class Hashing {
    ...
    public static HashFunction hmacSha256(Key key) {
        return new MacHashFunction(getTabbarModel.HASHING_ALGORITHM, key, hmacToString("hmacSha256", key));
    }

    public static HashFunction hmacSha256(byte[] bArr) {
        return hmacSha256((Key) new SecretKeySpec((byte[]) Preconditions.checkNotNull(bArr), getTabbarModel.HASHING_ALGORITHM));
    }
