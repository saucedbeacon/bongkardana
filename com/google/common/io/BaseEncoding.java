...
public abstract class BaseEncoding {
    ...
    static final class Alphabet {
        ...
        public final char encode(int i) {
            ...
            if (i != max) {
                ...
                onCancelLoad.setMax(-1781831122, oncanceled);
                onCancelLoad.getMin(-1781831122, oncanceled);
            }
            return this.chars[i];
        }
        ...
        public InputStream decodingStream(final Reader reader) {
            ...
            return new InputStream() {
                ...
                public int read() throws IOException {
                        ...
                        if (read != -1) {
                            ...
                            if (StandardBaseEncoding.this.paddingChar == null || StandardBaseEncoding.this.paddingChar.charValue() != c) {
                                if (!this.hitPadding) {
                                    ...
                                    StringBuilder sb = new StringBuilder("Expected padding character but found '");
                                    sb.append(c);
                                    sb.append("' at index ");
                    ...
                    StringBuilder sb3 = new StringBuilder("Padding cannot start at index ");
    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        /* access modifiers changed from: package-private */
        public final BaseEncoding newInstance(Alphabet alphabet, @NullableDecl Character ch) {
