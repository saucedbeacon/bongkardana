...
public final class Monitor {
    ...
    public static abstract class Guard {
        ...
        protected Guard(Monitor monitor2) {
            this.monitor = (Monitor) Preconditions.checkNotNull(monitor2, BlobStatic.INVTP_TYPE_MONITOR);
    ...
    public final boolean enter(long r8, java.util.concurrent.TimeUnit r10) {
        /*
            r7 = this;
    ...
    public final boolean enterWhen(com.google.common.util.concurrent.Monitor.Guard r11, long r12, java.util.concurrent.TimeUnit r14) throws java.lang.InterruptedException {
        ...
        L_0x002a:
            ...
            return r5
        L_0x0035:
            boolean r12 = r11.isSatisfied()     // Catch:{ all -> 0x0051 }
            if (r12 != 0) goto L_0x004a
            int r12 = (r8 > r6 ? 1 : (r8 == r6 ? 0 : -1))
            if (r12 != 0) goto L_0x0040
            goto L_0x0044
        L_0x0040:
            long r0 = remainingNanos(r8, r0)     // Catch:{ all -> 0x0051 }
        L_0x0044:
            boolean r11 = r10.awaitNanos(r11, r0, r3)     // Catch:{ all -> 0x0051 }
        ...
        L_0x0051:
            ...
            r10.signalNextWaiter()     // Catch:{ all -> 0x0058 }
            goto L_0x005d
        L_0x0058:
            r11 = move-exception
            r2.unlock()
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean enterWhenUninterruptibly(com.google.common.util.concurrent.Monitor.Guard r12, long r13, java.util.concurrent.TimeUnit r15) {
        /*
            r11 = this;
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean waitForUninterruptibly(com.google.common.util.concurrent.Monitor.Guard r8, long r9, java.util.concurrent.TimeUnit r11) {
        /*
            r7 = this;
