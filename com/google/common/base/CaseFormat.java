...
public enum CaseFormat {
    ...
    public final String to(CaseFormat caseFormat, String str) {
        ...
        if (length != max) {
            ...
            onCancelLoad.setMax(-1346263290, oncanceled);
            onCancelLoad.getMin(-1346263290, oncanceled);
        }
    ...
    public String convert(CaseFormat caseFormat, String str) {
        ...
        if (length != max) {
            onCanceled oncanceled = new onCanceled(length, max, 1);
            onCancelLoad.setMax(-1066456592, oncanceled);
            onCancelLoad.getMin(-1066456592, oncanceled);
        }
