...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public com.google.common.collect.ImmutableMap<K, V> getAll(java.lang.Iterable<? extends K> r8) throws java.util.concurrent.ExecutionException {
        ...
        L_0x002d:
            ...
            goto L_0x000e
        L_0x0030:
            boolean r8 = r1.isEmpty()     // Catch:{ all -> 0x008d }
            if (r8 != 0) goto L_0x007e
            com.google.common.cache.CacheLoader<? super K, V> r8 = r7.defaultLoader     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            java.util.Map r8 = r7.loadAll(r1, r8)     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            java.util.Iterator r4 = r1.iterator()     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
        L_0x0040:
            boolean r5 = r4.hasNext()     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            if (r5 == 0) goto L_0x007e
            java.lang.Object r5 = r4.next()     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            java.lang.Object r6 = r8.get(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            if (r6 == 0) goto L_0x0054
            r0.put(r5, r6)     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            goto L_0x0040
        L_0x0054:
            com.google.common.cache.CacheLoader$InvalidCacheLoadException r8 = new com.google.common.cache.CacheLoader$InvalidCacheLoadException     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            java.lang.String r4 = "loadAll failed to return a value for "
            java.lang.String r5 = java.lang.String.valueOf(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            java.lang.String r4 = r4.concat(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            r8.<init>(r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
            throw r8     // Catch:{ UnsupportedLoadingOperationException -> 0x0064 }
        L_0x0064:
            java.util.Iterator r8 = r1.iterator()     // Catch:{ all -> 0x008d }
        L_0x0068:
            boolean r1 = r8.hasNext()     // Catch:{ all -> 0x008d }
            if (r1 == 0) goto L_0x007e
            java.lang.Object r1 = r8.next()     // Catch:{ all -> 0x008d }
            int r3 = r3 + -1
            com.google.common.cache.CacheLoader<? super K, V> r4 = r7.defaultLoader     // Catch:{ all -> 0x008d }
            java.lang.Object r4 = r7.get(r1, r4)     // Catch:{ all -> 0x008d }
            r0.put(r1, r4)     // Catch:{ all -> 0x008d }
            goto L_0x0068
        L_0x007e:
            com.google.common.collect.ImmutableMap r8 = com.google.common.collect.ImmutableMap.copyOf(r0)     // Catch:{ all -> 0x008d }
