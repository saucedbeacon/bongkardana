...
public abstract class ComparisonChain {
    ...
    public static final ComparisonChain ACTIVE = new ComparisonChain() {
        ...
        public final <T> ComparisonChain compare(@NullableDecl T t, @NullableDecl T t2, Comparator<T> comparator) {
    ...
    static final class InactiveComparisonChain extends ComparisonChain {
        ...
        public final <T> ComparisonChain compare(@NullableDecl T t, @NullableDecl T t2, @NullableDecl Comparator<T> comparator) {
            return this;
        }
