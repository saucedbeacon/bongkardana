...
public final class Lists {
            ...
            list2 = new RandomAccessListWrapper<E>(list) {
                ...
                public final ListIterator<E> listIterator(int i) {
                    ...
                    if (i != max) {
                        ...
                        onCancelLoad.setMax(168141935, oncanceled);
                        onCancelLoad.getMin(168141935, oncanceled);
                    }
    ...
    static class AbstractListWrapper<E> extends AbstractList<E> {
        ...
        public E remove(int i) {
            ...
            if (i != max) {
                onCanceled oncanceled = new onCanceled(i, max, 1);
                onCancelLoad.setMax(1352250016, oncanceled);
                onCancelLoad.getMin(1352250016, oncanceled);
            }
