...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    /* access modifiers changed from: package-private */
    public final int findEntryByKey(@NullableDecl Object obj) {
        return findEntryByKey(obj, Hashing.smearedHash(obj));
    }

    /* access modifiers changed from: package-private */
    public final int findEntryByKey(@NullableDecl Object obj, int i) {
        return findEntry(obj, i, this.hashTableKToV, this.nextInBucketKToV, this.keys);
    }

    /* access modifiers changed from: package-private */
    public final int findEntryByValue(@NullableDecl Object obj) {
        return findEntryByValue(obj, Hashing.smearedHash(obj));
    }

    /* access modifiers changed from: package-private */
    public final int findEntryByValue(@NullableDecl Object obj, int i) {
        return findEntry(obj, i, this.hashTableVToK, this.nextInBucketVToK, this.values);
    }

    /* access modifiers changed from: package-private */
    public final int findEntry(@NullableDecl Object obj, int i, int[] iArr, int[] iArr2, Object[] objArr) {
    ...
    /* access modifiers changed from: package-private */
    @NullableDecl
    public final K getInverse(@NullableDecl Object obj) {
    ...
    /* access modifiers changed from: package-private */
    @NullableDecl
    public final V put(@NullableDecl K k, @NullableDecl V v, boolean z) {
    ...
    /* access modifiers changed from: package-private */
    @NullableDecl
    public final K putInverse(@NullableDecl V v, @NullableDecl K k, boolean z) {
    ...
    /* access modifiers changed from: package-private */
    @NullableDecl
    public final K removeInverse(@NullableDecl Object obj) {
        int smearedHash = Hashing.smearedHash(obj);
    ...
    final class ValueSet extends View<K, V, V> {
        ...
        public final V forEntry(int i) {
            ...
            if (i != max) {
                ...
                onCancelLoad.setMax(-213867593, oncanceled);
                onCancelLoad.getMin(-213867593, oncanceled);
            }
