...
public final class Collections2 {
    ...
    static StringBuilder newStringBuilderForCollection(int i) {
        ...
        return new StringBuilder((int) Math.min(((long) i) * 8, ConvertUtils.GB));
    }
    ...
    static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public final String toString() {
            StringBuilder sb = new StringBuilder("orderedPermutationCollection(");
    ...
    static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public final String toString() {
            StringBuilder sb = new StringBuilder("permutations(");
            sb.append(this.inputList);
            sb.append(")");
            return sb.toString();
        }
    ...
    static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            this.c = iArr;
            this.f11027o = new int[size];
            Arrays.fill(iArr, 0);
            Arrays.fill(this.f11027o, 1);
        }
        ...
        public void calculateNextPermutation() {
            ...
            if (size != -1) {
                ...
                while (true) {
                    int[] iArr = this.c;
                    int i2 = this.j;
                    int i3 = iArr[i2] + this.f11027o[i2];
                    if (i3 < 0) {
                        switchDirection();
                    } else if (i3 != i2 + 1) {
