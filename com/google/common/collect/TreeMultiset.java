...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    enum Aggregate {
        SIZE {
            ...
            /* access modifiers changed from: package-private */
            public final long treeAggregate(@NullableDecl AvlNode<?> avlNode) {
                if (avlNode == null) {
                    return 0;
                }
    ...
    public final int setCount(@NullableDecl E e, int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(-1461763681, oncanceled);
            onCancelLoad.getMin(-1461763681, oncanceled);
        }
    ...
    static final class Reference<T> {
        ...
        public final void checkAndSet(@NullableDecl T t, T t2) {
            if (this.value == t) {
                this.value = t2;
                return;
            }
    ...
    static final class AvlNode<E> {
        ...
        /* access modifiers changed from: package-private */
        public final AvlNode<E> add(Comparator<? super E> comparator, @NullableDecl E e, int i, int[] iArr) {
        ...
        /* access modifiers changed from: package-private */
        public final AvlNode<E> remove(Comparator<? super E> comparator, @NullableDecl E e, int i, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        /* access modifiers changed from: package-private */
        public final AvlNode<E> setCount(Comparator<? super E> comparator, @NullableDecl E e, int i, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
        ...
        /* access modifiers changed from: package-private */
        public final AvlNode<E> setCount(Comparator<? super E> comparator, @NullableDecl E e, int i, int i2, int[] iArr) {
            int compare = comparator.compare(e, this.elem);
            if (compare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode == null) {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        Serialization.getFieldSetter(cls, InvoiceConstant.HEADER).set(this, (Object) avlNode);
        successor(avlNode, avlNode);
