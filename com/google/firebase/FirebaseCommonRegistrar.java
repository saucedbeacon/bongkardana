...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, getAnimator.setMin));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, setPostOnViewCreatedAlpha.length));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, isHideReplaced.length));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, getPostOnViewCreatedAlpha.getMax));
