...
public class CrashlyticsReportDataCapture {
    ...
    static final String GENERATOR = String.format(Locale.US, "Crashlytics Android SDK/%s", new Object[]{"18.0.1"});
    ...
    public CrashlyticsReport captureReportData(String str, long j) {
        ...
        if (length != max) {
            ...
            onCancelLoad.setMax(1811422021, oncanceled);
            onCancelLoad.getMin(1811422021, oncanceled);
        }
    ...
    private CrashlyticsReport.Builder buildReportData() {
        return CrashlyticsReport.builder().setSdkVersion("18.0.1").setGmpAppId(this.appData.googleAppId).setInstallationUuid(this.idManager.getCrashlyticsInstallId()).setBuildVersion(this.appData.versionCode).setDisplayVersion(this.appData.versionName).setPlatform(4);
    }
