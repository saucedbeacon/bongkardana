...
final class PDF417HighLevelEncoder {
    ...
    private static final byte[] TEXT_PUNCTUATION_RAW = {59, 60, 62, SignedBytes.MAX_POWER_OF_TWO, 91, 92, 93, Framer.STDIN_REQUEST_FRAME_PREFIX, 96, 126, Framer.ENTER_FRAME_PREFIX, 13, 9, 44, 58, 10, Framer.STDIN_FRAME_PREFIX, 46, 36, 47, 34, 124, 42, 40, 41, 63, 123, 125, 39, 0};
            ...
            while (true) {
                ...
                while (i < length) {
                    ...
                    if (determineConsecutiveDigitCount >= 13) {
                        ...
                        i3 = i + determineConsecutiveDigitCount;
                        i4 = 2;
                    } else {
                        ...
                        if (determineConsecutiveTextCount >= 5 || determineConsecutiveDigitCount == length) {
                            ...
                            i5 = encodeText(str, i, determineConsecutiveTextCount, sb, i5);
                            ...
                            int i6 = determineConsecutiveBinaryCount + i;
                            byte[] bytes2 = str.substring(i, i6).getBytes(charset);
