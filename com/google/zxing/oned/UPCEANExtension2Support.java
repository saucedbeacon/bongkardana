...
final class UPCEANExtension2Support {
    ...
    public final Result decodeRow(int i, BitArray bitArray, int[] iArr) throws NotFoundException {
        ...
        float f = (float) i;
        Result result = new Result(obj, (byte[]) null, new ResultPoint[]{new ResultPoint(((float) (iArr[0] + iArr[1])) / 2.0f, f), new ResultPoint((float) decodeMiddle, f)}, BarcodeFormat.UPC_EAN_EXTENSION);
