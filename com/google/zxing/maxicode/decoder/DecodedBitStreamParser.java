...
final class DecodedBitStreamParser {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{Framer.ENTER_FRAME_PREFIX, 34, 35, 36, Ascii.EM, Ascii.SUB, Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4, Ascii.NAK, 22, Ascii.ETB, Ascii.CAN, 13, Ascii.SO, Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.VT, Ascii.FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{Framer.ENTER_FRAME_PREFIX, 34, 35, 36, Ascii.EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, 22, Ascii.ETB, Ascii.CAN, 13, Ascii.SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.VT, Ascii.FF, 1, 2}))});
    }
