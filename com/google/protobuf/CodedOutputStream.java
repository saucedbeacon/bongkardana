...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public final void inefficientWriteStringNoTag(String str, Utf8.UnpairedSurrogateException unpairedSurrogateException) throws IOException {
        ...
        if (length != max) {
            ...
            onCancelLoad.setMax(-1783331702, oncanceled);
            onCancelLoad.getMin(-1783331702, oncanceled);
        }
    ...
    static class ArrayEncoder extends CodedOutputStream {
        ...
        public final void write(byte[] bArr, int i, int i2) throws IOException {
            ...
            if (i != max) {
                ...
                onCancelLoad.setMax(1028252561, oncanceled);
                onCancelLoad.getMin(1028252561, oncanceled);
            }
            try {
    ...
    static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public final void writeByteArrayNoTag(byte[] bArr, int i, int i2) throws IOException {
            ...
            if (i != max) {
                onCanceled oncanceled = new onCanceled(i, max, 1);
                onCancelLoad.setMax(-650733937, oncanceled);
                onCancelLoad.getMin(-650733937, oncanceled);
            }
            writeUInt32NoTag(i2);
            write(bArr, i, i2);
        }
        ...
        public final void writeFixed32NoTag(int i) throws IOException {
            ...
            if (i != max) {
                onCanceled oncanceled = new onCanceled(i, max, 1);
                onCancelLoad.setMax(1578947517, oncanceled);
                onCancelLoad.getMin(1578947517, oncanceled);
            }
