...
interface zzyn {
    ...
    void zza(int i, zztq zztq) throws IOException;

    <K, V> void zza(int i, zzvz<K, V> zzvz, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzxc zzxc) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzxc zzxc) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzxc zzxc) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zztq> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzxc zzxc) throws IOException;
    ...
    @Deprecated
    void zzdj(int i) throws IOException;

    @Deprecated
    void zzdk(int i) throws IOException;
