...
public final class zzje extends zzjf {
    private static final char[] zzadm = {'+'};
    private static final char[] zzadn = "0123456789ABCDEF".toCharArray();
    private final boolean zzado;
    private final boolean[] zzadp;

    public zzje(String str, boolean z) {
