                ...
                if (name3.startsWith("set")) {
                    ...
                    try {
                        ...
                        if (((Boolean) cls.getMethod(valueOf.length() != 0 ? "has".concat(valueOf) : new String("has"), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                            ...
                            zza(substring, cls.getMethod(valueOf2.length() != 0 ? ContactEventType.CONTACT_GET.concat(valueOf2) : new String(ContactEventType.CONTACT_GET), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
                        }
