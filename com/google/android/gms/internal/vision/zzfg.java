...
final class zzfg implements zzjj {
    ...
    private zzfg(zzfe zzfe) {
        zzfe zzfe2 = (zzfe) zzga.zza(zzfe, TinyAppLogUtil.TINY_APP_STANDARD_OUTPUT);
        this.zzsd = zzfe2;
        zzfe2.zzss = this;
    }
    ...
    public final void zzh(int i, int i2) throws IOException {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(1983062280, oncanceled);
            onCancelLoad.getMin(1983062280, oncanceled);
        }
        this.zzsd.zzh(i, i2);
    }
    ...
    public final void zza(int i, String str) throws IOException {
        ...
        if (i != max) {
            onCanceled oncanceled = new onCanceled(i, max, 1);
            onCancelLoad.setMax(-1020255296, oncanceled);
            onCancelLoad.getMin(-1020255296, oncanceled);
        }
        int length = str != null ? str.length() : 0;
        int max2 = dispatchOnCancelled.setMax(length);
        if (length != max2) {
            onCanceled oncanceled2 = new onCanceled(length, max2, 1);
            onCancelLoad.setMax(-1020255296, oncanceled2);
            onCancelLoad.getMin(-1020255296, oncanceled2);
        }
        this.zzsd.zza(i, str);
    }
