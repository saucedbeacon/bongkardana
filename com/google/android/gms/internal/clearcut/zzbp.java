...
final class zzbp implements zzfr {
    ...
    private zzbp(zzbn zzbn) {
        zzbn zzbn2 = (zzbn) zzci.zza(zzbn, TinyAppLogUtil.TINY_APP_STANDARD_OUTPUT);
        this.zzfo = zzbn2;
        zzbn2.zzfz = this;
    }
    ...
    public final void zzf(int i, int i2) throws IOException {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(-1870872886, oncanceled);
            onCancelLoad.getMin(-1870872886, oncanceled);
        }
        this.zzfo.zzf(i, i2);
    }
