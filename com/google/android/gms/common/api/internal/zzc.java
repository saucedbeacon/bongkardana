...
public final class zzc extends Fragment implements LifecycleFragment {
    ...
    private Map<String, LifecycleCallback> zzb = Collections.synchronizedMap(new PlaybackStateCompat());
    ...
    public static zzc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (zzc3 == null || zzc3.isRemoving()) {
                zzc3 = new zzc();
                fragmentActivity.getSupportFragmentManager().length().setMax(zzc3, "SupportLifecycleFragmentImpl").length();
            }
