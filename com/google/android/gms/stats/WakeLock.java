...
public class WakeLock {
    ...
    public void release() {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r12.zzi     // Catch:{ all -> 0x006a }
            r10 = 1
            r11 = 0
            if (r1 == 0) goto L_0x003e
            java.util.Map<java.lang.String, java.lang.Integer[]> r1 = r12.zzj     // Catch:{ all -> 0x006a }
        ...
        L_0x003e:
            ...
            int r1 = r12.zzl     // Catch:{ all -> 0x006a }
            if (r1 != r10) goto L_0x0065
        L_0x0046:
            com.google.android.gms.common.stats.WakeLockTracker r1 = com.google.android.gms.common.stats.WakeLockTracker.getInstance()     // Catch:{ all -> 0x006a }
            android.content.Context r2 = r12.zzh     // Catch:{ all -> 0x006a }
            android.os.PowerManager$WakeLock r3 = r12.zzb     // Catch:{ all -> 0x006a }
            java.lang.String r3 = com.google.android.gms.common.stats.StatsUtils.getEventKey((android.os.PowerManager.WakeLock) r3, (java.lang.String) r6)     // Catch:{ all -> 0x006a }
            r4 = 8
            java.lang.String r5 = r12.zze     // Catch:{ all -> 0x006a }
            r7 = 0
            int r8 = r12.zzd     // Catch:{ all -> 0x006a }
            java.util.List r9 = r12.zza()     // Catch:{ all -> 0x006a }
            r1.registerEvent(r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ all -> 0x006a }
            int r1 = r12.zzl     // Catch:{ all -> 0x006a }
            int r1 = r1 - r10
            r12.zzl = r1     // Catch:{ all -> 0x006a }
        L_0x0065:
