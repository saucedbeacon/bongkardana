...
final class MaterialCalendarGridView extends GridView {
    ...
    public final boolean onKeyDown(int i, KeyEvent keyEvent) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(-91868694, oncanceled);
            onCancelLoad.getMin(-91868694, oncanceled);
        }
    ...
    public final void onDraw(@NonNull Canvas canvas) {
        ...
        for (setNegativeButton next : dateSelector.getSelectedRanges()) {
            if (!(next.setMax == null || next.getMin == null)) {
                long longValue = ((Long) next.setMax).longValue();
                long longValue2 = ((Long) next.getMin).longValue();
    ...
    public final void onFocusChanged(boolean z, int i, Rect rect) {
        ...
        if (i != max) {
            onCanceled oncanceled = new onCanceled(i, max, 1);
            onCancelLoad.setMax(-420569028, oncanceled);
            onCancelLoad.getMin(-420569028, oncanceled);
        }
        if (z) {
            gainFocus(i, rect);
        } else {
