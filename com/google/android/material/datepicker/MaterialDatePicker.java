...
public final class MaterialDatePicker<S> extends setFilterBitmap {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        this.background.setElevation(ViewCompat.Mean$Arithmetic(dialog.getWindow().getDecorView()));
        return dialog;
    }
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        ViewCompat.toIntRange(textView, 1);
    ...
    public void startPickerFragment() {
        ...
        updateHeader();
        setColorFilter setcolorfilter = new setColorFilter(getChildFragmentManager());
        int i = R.id.mtrl_calendar_frame;
        PickerFragment<S> pickerFragment2 = this.pickerFragment;
        if (i != 0) {
            setcolorfilter.length(i, pickerFragment2, (String) null, 2);
    ...
    private void initHeaderToggle(Context context) {
        ...
        ViewCompat.getMin((View) this.headerToggleButton, (setOnCancelListener) null);
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, cancelAll.getMin(context, R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], cancelAll.getMin(context, R.drawable.material_ic_edit_black_24dp));
    ...
    public static final class Builder<S> {
        ...
        @NonNull
        public static Builder<setNegativeButton<Long, Long>> dateRangePicker() {
        ...
        @NonNull
        public final Builder<S> setTheme(@StyleRes int i) {
        ...
        @NonNull
        public final Builder<S> setTitleText(@StringRes int i) {
        ...
        @NonNull
        public final Builder<S> setTitleText(@Nullable CharSequence charSequence) {
