...
public class MaterialShapeDrawable extends Drawable implements allOf, Shapeable {
    ...
    public void setShadowCompatibilityMode(int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(1059754864, oncanceled);
            onCancelLoad.getMin(1059754864, oncanceled);
        }
    ...
    private boolean updateTintFilter() {
        ...
        if (!setNegativeButtonIcon.getMax(porterDuffColorFilter, this.tintFilter) || !setNegativeButtonIcon.getMax(porterDuffColorFilter2, this.strokeTintFilter)) {
            return true;
        }
        return false;
    }
