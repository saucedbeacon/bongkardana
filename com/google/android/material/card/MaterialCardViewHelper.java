...
class MaterialCardViewHelper {
    ...
    public void setCheckedIcon(@Nullable Drawable drawable) {
        ...
        if (drawable != null) {
            Drawable intRange = RequiresPermission.Read.toIntRange(drawable.mutate());
            this.checkedIcon = intRange;
            RequiresPermission.Read.setMin(intRange, this.checkedIconTint);
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if (ViewCompat.IsOverlapping(this.materialCardView) == 1) {
                i3 = i7;
                i4 = i10;
            } else {
                i4 = i7;
