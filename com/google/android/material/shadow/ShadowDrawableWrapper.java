...
@Deprecated
public class ShadowDrawableWrapper extends INotificationSideChannel.Stub {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.shadowStartColor = IntRange.setMax(context, R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = IntRange.setMax(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = IntRange.setMax(context, R.color.design_fab_shadow_end_color);
