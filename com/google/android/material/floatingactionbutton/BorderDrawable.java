...
class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, (float) rect2.top, 0.0f, (float) rect2.bottom, new int[]{NavigationRes.setMax(this.topOuterStrokeColor, this.currentBorderTintColor), NavigationRes.setMax(this.topInnerStrokeColor, this.currentBorderTintColor), NavigationRes.setMax(NavigationRes.getMax(this.topInnerStrokeColor, 0), this.currentBorderTintColor), NavigationRes.setMax(NavigationRes.getMax(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), NavigationRes.setMax(this.bottomInnerStrokeColor, this.currentBorderTintColor), NavigationRes.setMax(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
