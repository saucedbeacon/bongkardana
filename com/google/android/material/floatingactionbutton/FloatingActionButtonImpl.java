...
class FloatingActionButtonImpl {
    ...
    public void setRippleColor(@Nullable ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            RequiresPermission.Read.setMin(drawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f, float f2, float f3) {
        ...
        ObjectAnimator ofObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() {
            public /* bridge */ /* synthetic */ Object evaluate(float f, @NonNull Object obj, @NonNull Object obj2) {
    ...
    private boolean shouldAnimateVisibilityChange() {
        return ViewCompat.asInterface(this.view) && !this.view.isInEditMode();
    }
