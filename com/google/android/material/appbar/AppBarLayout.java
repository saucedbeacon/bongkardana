...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.getMax {
    ...
    public AppBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.getMin((View) this, obtainStyledAttributes.getDrawable(R.styleable.AppBarLayout_android_background));
    ...
    public void setStatusBarForeground(@Nullable Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable3 != null) {
                ...
                RequiresPermission.Read.setMax(this.statusBarForeground, ViewCompat.IsOverlapping(this));
    ...
    public void setStatusBarForegroundResource(@DrawableRes int i) {
        setStatusBarForeground(cancelAll.getMin(getContext(), i));
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && ViewCompat.ICustomTabsCallback(this) && shouldOffsetFirstChild()) {
            int measuredHeight = getMeasuredHeight();
            if (mode == Integer.MIN_VALUE) {
                int measuredHeight2 = getMeasuredHeight() + getTopInset();
                int size = View.MeasureSpec.getSize(i2);
                measuredHeight = measuredHeight2 < 0 ? 0 : measuredHeight2 > size ? size : measuredHeight2;
            } else if (mode == 0) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (ViewCompat.ICustomTabsCallback(this) && shouldOffsetFirstChild()) {
            int topInset = getTopInset();
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
                ViewCompat.equals(getChildAt(childCount), topInset);
            }
        }
        invalidateScrollRanges();
    ...
    public void setExpanded(boolean z) {
        setExpanded(z, ViewCompat.asInterface(this));
    }
    ...
    public final int getTotalScrollRange() {
        ...
        while (true) {
            ...
            if (i2 == 0 && ViewCompat.ICustomTabsCallback(childAt)) {
                i3 -= getTopInset();
            }
            if ((i4 & 2) != 0) {
                i3 -= ViewCompat.valueOf(childAt);
                break;
            }
            i2++;
        }
    ...
    public int getDownNestedPreScrollRange() {
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i4 & 5) != 5) {
                ...
                if ((i4 & 8) != 0) {
                    valueOf = ViewCompat.valueOf(childAt);
                } else if ((i4 & 2) != 0) {
                    valueOf = measuredHeight - ViewCompat.valueOf(childAt);
                } else {
                    i = i5 + measuredHeight;
                    if (childCount == 0 && ViewCompat.ICustomTabsCallback(childAt)) {
    ...
    public void onOffsetChanged(int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(1946031844, oncanceled);
            onCancelLoad.getMin(1946031844, oncanceled);
        }
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        if (valueOf == 0) {
            int childCount = getChildCount();
            valueOf = childCount > 0 ? ViewCompat.valueOf(getChildAt(childCount - 1)) : 0;
            if (valueOf == 0) {
                return getHeight() / 3;
            }
        }
        return (valueOf * 2) + topInset;
    }
    ...
    public final int getTopInset() {
        ...
        if (windowInsetsCompat != null) {
            return windowInsetsCompat.setMax();
        }
        return 0;
    }
    ...
    private boolean shouldOffsetFirstChild() {
        if (getChildCount() > 0) {
            ...
            if (childAt.getVisibility() == 8 || ViewCompat.ICustomTabsCallback(childAt)) {
                return false;
            }
            return true;
        }
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    if (checkFlag(scrollFlags, 2)) {
                        i2 += ViewCompat.valueOf(childAt);
                    } else if (checkFlag(scrollFlags, 5)) {
                        int valueOf = ViewCompat.valueOf(childAt) + i2;
                        if (topBottomOffsetForScrollingSibling < valueOf) {
                            i = valueOf;
                        } else {
                            i2 = valueOf;
                        }
        ...
        public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, int i3, int i4) {
            if (((CoordinatorLayout.length) t.getLayoutParams()).height != -2) {
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i) {
            ...
            if (i3 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    i2 = ViewCompat.valueOf(childAt) + t.getTopInset();
                } else {
                    i2 = Math.round(((float) childAt.getHeight()) * this.offsetToChildIndexOnLayoutPerc);
                }
                setHeaderTopBottomOffset(coordinatorLayout, t, i5 + i2);
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ViewCompat.getMin((View) coordinatorLayout, onSupportActionModeFinished.setMax.values.length());
            ViewCompat.getMin((View) coordinatorLayout, onSupportActionModeFinished.setMax.toDoubleRange.length());
            View findFirstScrollingChild = findFirstScrollingChild(coordinatorLayout);
            if (findFirstScrollingChild != null && t.getTotalScrollRange() != 0 && (((CoordinatorLayout.length) findFirstScrollingChild.getLayoutParams()).setMin instanceof ScrollingViewBehavior)) {
        ...
        private void addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, @NonNull T t, @NonNull View view) {
            if (getTopBottomOffsetForScrollingSibling() != (-t.getTotalScrollRange()) && view.canScrollVertically(1)) {
                addActionToExpand(coordinatorLayout, t, onSupportActionModeFinished.setMax.values, false);
            }
            ...
            if (view.canScrollVertically(-1)) {
                ...
                if (i != 0) {
                    ...
                    ViewCompat.getMin(coordinatorLayout, onSupportActionModeFinished.setMax.toDoubleRange, (CharSequence) null, new setSupportProgressBarIndeterminateVisibility() {
            ...
            addActionToExpand(coordinatorLayout, t, onSupportActionModeFinished.setMax.toDoubleRange, true);
        }

        private void addActionToExpand(CoordinatorLayout coordinatorLayout, @NonNull final T t, @NonNull onSupportActionModeFinished.setMax setmax, final boolean z) {
            ViewCompat.getMin(coordinatorLayout, setmax, (CharSequence) null, new setSupportProgressBarIndeterminateVisibility() {
                public boolean perform(@NonNull View view, @Nullable setSupportProgressBarIndeterminateVisibility.setMax setmax) {
                    t.setExpanded(z);
                    return true;
                }
        ...
        public int setHeaderTopBottomOffset(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, int i3) {
            ...
            if (i2 == 0 || topBottomOffsetForScrollingSibling < i2 || topBottomOffsetForScrollingSibling > i3) {
                ...
                if (topBottomOffsetForScrollingSibling != i5) {
                    int interpolateOffset = t.hasChildWithInterpolator() ? interpolateOffset(t, i5) : i5;
        ...
        private void updateAppBarLayoutDrawableState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, boolean z) {
            ...
            if (appBarChildOnOffset != null) {
                ...
                boolean z2 = false;
                if ((scrollFlags & 1) != 0) {
                    int valueOf = ViewCompat.valueOf(appBarChildOnOffset);
                    if (i2 <= 0 || (scrollFlags & 12) == 0 ? !((scrollFlags & 2) == 0 || (-i) < (appBarChildOnOffset.getBottom() - valueOf) - t.getTopInset()) : (-i) >= (appBarChildOnOffset.getBottom() - valueOf) - t.getTopInset()) {
                        z2 = true;
                    }
                }
                if (t.isLiftOnScroll()) {
        ...
        private boolean shouldJumpElevationState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            int i = 0;
            while (i < size) {
                CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.length) dependents.get(i).getLayoutParams()).setMin;
        ...
        private View findFirstScrollingChild(@NonNull CoordinatorLayout coordinatorLayout) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if ((childAt instanceof setOnItemSelectedListener) || (childAt instanceof ListView) || (childAt instanceof ScrollView)) {
                    return childAt;
                }
            }
            return null;
        ...
        public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            while (i < childCount) {
                ...
                if (childAt.getTop() + topAndBottomOffset > 0 || bottom < 0) {
                    ...
                    if (bottom == ViewCompat.valueOf(childAt) + t.getTopInset()) {
                        z = true;
                    }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(@NonNull View view, @NonNull View view2) {
            CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.length) view2.getLayoutParams()).setMin;
            if (behavior instanceof BaseBehavior) {
                ViewCompat.equals(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) behavior).offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
        ...
        private static int getAppBarLayoutOffset(@NonNull AppBarLayout appBarLayout) {
            CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.length) appBarLayout.getLayoutParams()).setMin;
            if (behavior instanceof BaseBehavior) {
