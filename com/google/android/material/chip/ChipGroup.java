...
public class ChipGroup extends FlowLayout {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        onSupportActionModeFinished.getMin(accessibilityNodeInfo).getMin((Object) onSupportActionModeFinished.getMax.length(getRowCount(), isSingleLine() ? getChipCount() : -1, false, isSingleSelection() ? 1 : 2));
    }
    ...
    public void setShowDividerHorizontal(int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(1871104253, oncanceled);
            onCancelLoad.getMin(1871104253, oncanceled);
        }
