    ...
    public ScrimInsetsFrameLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.setMax((View) this, (AppCompatActivity) new AppCompatActivity() {
            public WindowInsetsCompat onApplyWindowInsets(View view, @NonNull WindowInsetsCompat windowInsetsCompat) {
                ...
                ScrimInsetsFrameLayout.this.insets.set(windowInsetsCompat.getMax(), windowInsetsCompat.setMax(), windowInsetsCompat.setMin(), windowInsetsCompat.getMin());
                ScrimInsetsFrameLayout.this.onInsetsChanged(windowInsetsCompat);
                ScrimInsetsFrameLayout.this.setWillNotDraw(!windowInsetsCompat.length() || ScrimInsetsFrameLayout.this.insetForeground == null);
                ViewCompat.equals(ScrimInsetsFrameLayout.this);
