...
public final class MaterialContainerTransform extends Transition {
    ...
    public final void captureStartValues(@NonNull hasIcon hasicon) {
        captureValues(hasicon, this.startView, this.startViewId, this.startShapeAppearanceModel);
    }

    public final void captureEndValues(@NonNull hasIcon hasicon) {
        captureValues(hasicon, this.endView, this.endViewId, this.endShapeAppearanceModel);
    }

    private static void captureValues(@NonNull hasIcon hasicon, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            hasicon.setMin = TransitionUtils.findDescendantOrAncestorById(hasicon.setMin, i);
        } else if (view != null) {
            hasicon.setMin = view;
        } else if (hasicon.setMin.getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            hasicon.setMin.setTag(R.id.mtrl_motion_snapshot_view, (Object) null);
            hasicon.setMin = (View) hasicon.setMin.getTag(R.id.mtrl_motion_snapshot_view);
        }
        View view2 = hasicon.setMin;
        if (ViewCompat.asInterface(view2) || view2.getWidth() != 0 || view2.getHeight() != 0) {
            ...
            hasicon.setMax.put(PROP_BOUNDS, relativeBounds);
            hasicon.setMax.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view2, relativeBounds, shapeAppearanceModel));
        }
    }
    ...
    @Nullable
    public final Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable hasIcon hasicon, @Nullable hasIcon hasicon2) {
        final View view;
        View view2;
        hasIcon hasicon3 = hasicon;
        hasIcon hasicon4 = hasicon2;
        if (!(hasicon3 == null || hasicon4 == null)) {
            RectF rectF = (RectF) hasicon3.setMax.get(PROP_BOUNDS);
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) hasicon3.setMax.get(PROP_SHAPE_APPEARANCE);
            if (!(rectF == null || shapeAppearanceModel == null)) {
                RectF rectF2 = (RectF) hasicon4.setMax.get(PROP_BOUNDS);
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) hasicon4.setMax.get(PROP_SHAPE_APPEARANCE);
                if (!(rectF2 == null || shapeAppearanceModel2 == null)) {
                    final View view3 = hasicon3.setMin;
                    final View view4 = hasicon4.setMin;
