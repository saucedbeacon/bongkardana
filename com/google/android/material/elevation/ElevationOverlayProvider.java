...
public class ElevationOverlayProvider {
    ...
    public int compositeOverlay(@ColorInt int i, float f) {
        ...
        return NavigationRes.getMax(MaterialColors.layer(NavigationRes.getMax(i, 255), this.elevationOverlayColor, calculateOverlayAlphaFraction), Color.alpha(i));
    }
    ...
    private boolean isThemeSurfaceColor(@ColorInt int i) {
        return NavigationRes.getMax(i, 255) == this.colorSurface;
    }
}
