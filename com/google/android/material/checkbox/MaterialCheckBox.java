...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public MaterialCheckBox(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.MaterialCheckBox_buttonTint)) {
            supportNavigateUpTo.setMin(this, MaterialResources.getColorStateList(context2, obtainStyledAttributes, R.styleable.MaterialCheckBox_buttonTint));
        }
    ...
    public void onAttachedToWindow() {
        ...
        if (this.useMaterialThemeColors && supportNavigateUpTo.setMin(this) == null) {
    ...
    public void setUseMaterialThemeColors(boolean z) {
        ...
        if (z) {
            supportNavigateUpTo.setMin(this, getMaterialThemeColorsTintList());
        } else {
            supportNavigateUpTo.setMin(this, (ColorStateList) null);
        }
    }
