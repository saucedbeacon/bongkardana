...
public class MotionSpec {
    ...
    private final PlaybackStateCompat.RepeatMode<String, PropertyValuesHolder[]> propertyValues = new PlaybackStateCompat.RepeatMode<>();
    private final PlaybackStateCompat.RepeatMode<String, MotionTiming> timings = new PlaybackStateCompat.RepeatMode<>();
    ...
    public <T> ObjectAnimator getAnimator(@NonNull String str, @NonNull T t, @NonNull Property<T, ?> property) {
        ...
        if (length != max) {
            ...
            onCancelLoad.setMax(143862458, oncanceled);
            onCancelLoad.getMin(143862458, oncanceled);
        }
    ...
    public long getTotalDuration() {
        ...
        for (int i = 0; i < size; i++) {
            MotionTiming motionTiming = (MotionTiming) this.timings.isInside[(i << 1) + 1];
