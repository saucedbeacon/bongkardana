...
class MaterialButtonHelper {
    ...
    public void loadFromAttributes(@NonNull TypedArray typedArray) {
        ...
        int viewCompat = ViewCompat.toString(this.materialButton);
        int paddingTop = this.materialButton.getPaddingTop();
        int FastBitmap$CoordinateSystem = ViewCompat.FastBitmap$CoordinateSystem(this.materialButton);
        ...
        ViewCompat.setMax(this.materialButton, viewCompat + this.insetLeft, paddingTop + this.insetTop, FastBitmap$CoordinateSystem + this.insetRight, paddingBottom + this.insetBottom);
    }
    ...
    public void setSupportBackgroundTintList(@Nullable ColorStateList colorStateList) {
        if (this.backgroundTint != colorStateList) {
            ...
            if (getMaterialShapeDrawable() != null) {
                RequiresPermission.Read.setMin((Drawable) getMaterialShapeDrawable(), this.backgroundTint);
            }
        }
    }
    ...
    public void setSupportBackgroundTintMode(@Nullable PorterDuff.Mode mode) {
        if (this.backgroundTintMode != mode) {
            ...
            if (getMaterialShapeDrawable() != null && this.backgroundTintMode != null) {
                RequiresPermission.Read.setMin((Drawable) getMaterialShapeDrawable(), this.backgroundTintMode);
            }
        }
    }
    ...
    private Drawable createBackground() {
        ...
        RequiresPermission.Read.setMin((Drawable) materialShapeDrawable, this.backgroundTint);
        PorterDuff.Mode mode = this.backgroundTintMode;
        if (mode != null) {
            RequiresPermission.Read.setMin((Drawable) materialShapeDrawable, mode);
        }
        ...
        if (IS_LOLLIPOP) {
            ...
            RequiresPermission.Read.getMin((Drawable) materialShapeDrawable3, -1);
        ...
        RequiresPermission.Read.setMin((Drawable) rippleDrawableCompat, RippleUtils.sanitizeRippleDrawableColor(this.rippleColor));
    ...
    public void setStrokeWidth(int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(-118270267, oncanceled);
            onCancelLoad.getMin(-118270267, oncanceled);
        }
    ...
    private void setVerticalInsets(@Dimension int i, @Dimension int i2) {
        ...
        ViewCompat.setMax(this.materialButton, viewCompat, (paddingTop + i) - i3, FastBitmap$CoordinateSystem, (paddingBottom + i2) - i4);
    }
