...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public void setBackgroundColor(@ColorInt int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(1407245394, oncanceled);
            onCancelLoad.getMin(1407245394, oncanceled);
        }
        if (isUsingOriginalBackground()) {
    ...
    public void setBackgroundResource(@DrawableRes int i) {
        setBackgroundDrawable(i != 0 ? cancelAll.getMin(getContext(), i) : null);
    }
    ...
    private void updateIconPosition(int i, int i2) {
        if (this.icon != null && getLayout() != null) {
            if (isIconStart() || isIconEnd()) {
                ...
                int textWidth = (((((i - getTextWidth()) - ViewCompat.FastBitmap$CoordinateSystem(this)) - i4) - this.iconPadding) - ViewCompat.toString(this)) / 2;
    ...
    public void setIconResource(@DrawableRes int i) {
        setIcon(i != 0 ? cancelAll.getMin(getContext(), i) : null);
    }
    ...
    public void setIconTintResource(@ColorRes int i) {
        setIconTint(cancelAll.setMin(getContext(), i));
    }
    ...
    private void updateIcon(boolean z) {
        ...
        if (drawable != null) {
            ...
            this.icon = mutate;
            RequiresPermission.Read.setMin(mutate, this.iconTint);
            PorterDuff.Mode mode = this.iconTintMode;
            if (mode != null) {
                RequiresPermission.Read.setMin(this.icon, mode);
            }
            int i = this.iconSize;
            if (i == 0) {
        ...
        Drawable[] max = TextViewCompat.setMax(this);
        boolean z2 = false;
        Drawable drawable3 = max[0];
        Drawable drawable4 = max[1];
        Drawable drawable5 = max[2];
    ...
    private void resetIconDrawable() {
        if (isIconStart()) {
            TextViewCompat.setMin(this, this.icon, (Drawable) null, (Drawable) null, (Drawable) null);
        } else if (isIconEnd()) {
            TextViewCompat.setMin(this, (Drawable) null, (Drawable) null, this.icon, (Drawable) null);
        } else if (isIconTop()) {
            TextViewCompat.setMin(this, (Drawable) null, this.icon, (Drawable) null, (Drawable) null);
        }
    }
    ...
    public void setRippleColorResource(@ColorRes int i) {
        if (isUsingOriginalBackground()) {
            setRippleColor(cancelAll.setMin(getContext(), i));
        }
    }
    ...
    public void setStrokeColorResource(@ColorRes int i) {
        if (isUsingOriginalBackground()) {
            setStrokeColor(cancelAll.setMin(getContext(), i));
        }
    }
    ...
    public void setCornerRadiusResource(@DimenRes int i) {
        ...
        if (i != max) {
            onCanceled oncanceled = new onCanceled(i, max, 1);
            onCancelLoad.setMax(2094807680, oncanceled);
            onCancelLoad.getMin(2094807680, oncanceled);
        }
        if (isUsingOriginalBackground()) {
