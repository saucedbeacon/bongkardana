...
public final class CodecSpecificDataUtil {
    ...
    private static final int[] AUDIO_SPECIFIC_CONFIG_SAMPLING_RATE_TABLE = {96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, BaseReq.MAX_SUPER_SIZE, SafetyNetStatusCodes.SAFE_BROWSING_UNSUPPORTED_THREAT_TYPES, 11025, 8000, 7350};
            ...
            if (!(aacAudioObjectType == 1 || aacAudioObjectType == 2 || aacAudioObjectType == 3 || aacAudioObjectType == 4 || aacAudioObjectType == 6 || aacAudioObjectType == 7 || aacAudioObjectType == 17)) {
                switch (aacAudioObjectType) {
                    ...
                    case 23:
                        break;
                    default:
                        throw new ParserException("Unsupported audio object type: ".concat(String.valueOf(aacAudioObjectType)));
                }
            }
