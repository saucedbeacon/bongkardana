...
public class TrackSelectionView extends LinearLayout {
    ...
    public static Pair<AlertDialog, TrackSelectionView> getDialog(Activity activity, CharSequence charSequence, DefaultTrackSelector defaultTrackSelector, int i) {
        ...
        return Pair.create(builder.setTitle(charSequence).setView(inflate).setPositiveButton(17039370, new performDestroyView(trackSelectionView)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create(), trackSelectionView);
    }
