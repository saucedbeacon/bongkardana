...
public class SsManifest implements FilterableManifest<SsManifest> {
    ...
    public static class StreamElement {
        ...
        public Uri buildRequestUri(int i, int i2) {
            ...
            String obj = this.chunkStartTimes.get(i2).toString();
            return UriUtil.resolveToUri(this.baseUri, this.chunkTemplate.replace(URL_PLACEHOLDER_BITRATE_1, num).replace(URL_PLACEHOLDER_BITRATE_2, num).replace(URL_PLACEHOLDER_START_TIME_1, obj).replace(URL_PLACEHOLDER_START_TIME_2, obj));
        }
    }
