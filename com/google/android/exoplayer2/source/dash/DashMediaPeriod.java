...
final class DashMediaPeriod implements MediaPeriod, SequenceableLoader.Callback<ChunkSampleStream<DashChunkSource>>, ChunkSampleStream.ReleaseCallback<DashChunkSource> {
    ...
    private static int[][] getGroupedAdaptationSetIndices(List<AdaptationSet> list) {
        ...
        for (int i = 0; i < size; i++) {
            sparseIntArray.put(list.get(i).f10793id, i);
        }
    ...
    private static int buildPrimaryAndEmbeddedTrackGroupInfos(List<AdaptationSet> list, int[][] iArr, int i, boolean[] zArr, boolean[] zArr2, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr) {
        ...
        while (i5 < i4) {
            ...
            if (i9 != -1) {
                ...
                sb.append(adaptationSet.f10793id);
                sb.append(":emsg");
                trackGroupArr[i9] = new TrackGroup(Format.createSampleFormat(sb.toString(), MimeTypes.APPLICATION_EMSG, (String) null, -1, (DrmInitData) null));
                trackGroupInfoArr[i9] = TrackGroupInfo.embeddedEmsgTrack(iArr2, i6);
            }
            if (i2 != -1) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(adaptationSet.f10793id);
                sb2.append(":cea608");
                trackGroupArr[i2] = new TrackGroup(Format.createTextSampleFormat(sb2.toString(), MimeTypes.APPLICATION_CEA608, 0, (String) null));
