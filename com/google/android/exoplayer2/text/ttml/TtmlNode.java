...
final class TtmlNode {
    ...
    public final boolean isActive(long j) {
        if (this.startTimeUs == C.TIME_UNSET && this.endTimeUs == C.TIME_UNSET) {
            return true;
        }
        if (this.startTimeUs <= j && this.endTimeUs == C.TIME_UNSET) {
            return true;
        }
        if (this.startTimeUs != C.TIME_UNSET || j >= this.endTimeUs) {
