...
final class MetadataUtil {
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == Atom.TYPE_data && readInt >= 22) {
            ...
            if (readUnsignedShort > 0) {
                String concat = "".concat(String.valueOf(readUnsignedShort));
                ...
                return new TextInformationFrame(str, (String) null, concat);
            }
        }
        StringBuilder sb2 = new StringBuilder("Failed to parse index/count attribute: ");
        sb2.append(Atom.getAtomTypeString(i));
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == Atom.TYPE_data) {
            ...
            if (str == null) {
                Log.w(TAG, "Unrecognized cover art flags: ".concat(String.valueOf(parseFullAtomFlags)));
                return null;
            }
