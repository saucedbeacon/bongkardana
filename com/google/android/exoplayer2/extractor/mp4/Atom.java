...
abstract class Atom {
    ...
    public static final int TYPE_uuid = Util.getIntegerCodeForString(HeaderConstant.HEADER_KEY_UUID);
    ...
    static final class ContainerAtom extends Atom {
        ...
        public final ContainerAtom getContainerAtomOfType(int i) {
            ...
            if (i != max) {
                ...
                onCancelLoad.setMax(94150259, oncanceled);
                onCancelLoad.getMin(94150259, oncanceled);
            }
