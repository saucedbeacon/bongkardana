...
public final class x {
    ...
    private static void a(Map<String, String> map, String str) {
        ...
        } else if (RVParams.ENABLE_SCROLLBAR.equals(str)) {
        ...
        } else if (CurrencyTextView.DEFAULT_LANGUAGE_CODE.equals(str)) {
        ...
        } else if (RVParams.PREFETCH_LOCATION.equals(str)) {
        ...
        } else if (RVParams.SHOW_LOADING.equals(str)) {
        ...
        } else if (RVParams.SHOW_REPORT_BTN.equals(str)) {
        ...
        } else if (RVParams.SHOW_TITLE_LOADING.equals(str)) {
