...
class FlexboxHelper {
    ...
    private void evaluateMinimumSizeForCompoundButton(CompoundButton compoundButton) {
        ...
        Drawable max = supportNavigateUpTo.setMax(compoundButton);
        int i2 = 0;
        if (max == null) {
            i = 0;
        } else {
            i = max.getMinimumWidth();
        }
        if (max != null) {
            i2 = max.getMinimumHeight();
        }
        if (minWidth == -1) {
            minWidth = i;
        }
    ...
    private void expandFlexItems(int i, int i2, FlexLine flexLine, int i3, int i4, boolean z) {
        ...
        int i7 = 1;
        boolean z2 = z;
        while (flexLine2.mTotalFlexGrow > 0.0f && i6 >= flexLine2.mMainSize) {
            int i8 = flexLine2.mMainSize;
            float f2 = ((float) (i6 - flexLine2.mMainSize)) / flexLine2.mTotalFlexGrow;
            ...
            while (i9 < flexLine2.mItemCount) {
                ...
                if (reorderedFlexItemAt == null || reorderedFlexItemAt.getVisibility() == 8) {
                    ...
                    FlexItem flexItem = (FlexItem) reorderedFlexItemAt.getLayoutParams();
                    int flexDirection = this.mFlexContainer.getFlexDirection();
                    if (flexDirection == 0 || flexDirection == i7) {
                        f = f2;
                        int i13 = i;
                        ...
                        if (this.mChildrenFrozen[i11] || flexItem.getFlexGrow() <= 0.0f) {
                            ...
                            float flexGrow = ((float) measuredWidth) + (f * flexItem.getFlexGrow());
                        ...
                        if (this.mChildrenFrozen[i11] || flexItem.getFlexGrow() <= 0.0f) {
                            ...
                            float flexGrow2 = ((float) measuredHeight3) + (f * flexItem.getFlexGrow());
                            if (i9 == flexLine2.mItemCount - 1) {
                                flexGrow2 += f3;
                                f3 = 0.0f;
                            }
                        ...
                        i5 = Math.max(i10, measuredWidth3 + flexItem.getMarginLeft() + flexItem.getMarginRight() + this.mFlexContainer.getDecorationLengthCrossAxis(reorderedFlexItemAt));
    ...
    private void shrinkFlexItems(int i, int i2, FlexLine flexLine, int i3, int i4, boolean z) {
        ...
        while (true) {
            int i8 = flexLine2.mMainSize;
            if (flexLine2.mTotalFlexShrink > 0.0f && i6 <= flexLine2.mMainSize) {
                float f = ((float) (flexLine2.mMainSize - i6)) / flexLine2.mTotalFlexShrink;
                flexLine2.mMainSize = i4 + flexLine2.mDividerLengthInMainSize;
                if (!z4) {
                    flexLine2.mCrossSize = Integer.MIN_VALUE;
                }
                    ...
                    if (reorderedFlexItemAt == null || reorderedFlexItemAt.getVisibility() == 8) {
                        ...
                        if (flexDirection == 0 || flexDirection == i7) {
                            ...
                            if (this.mChildrenFrozen[i11] || flexItem.getFlexShrink() <= 0.0f) {
                                ...
                                float flexShrink2 = ((float) measuredHeight3) - (flexItem.getFlexShrink() * f);
                                if (i9 == flexLine2.mItemCount - 1) {
                                    flexShrink2 += f2;
                                    f2 = 0.0f;
                                }
        ...
        if (alignItems != 0) {
            if (alignItems != 1) {
                if (alignItems == 2) {
                    ...
                    int measuredWidth = (((i5 - view.getMeasuredWidth()) + setMultiChoiceItems.getMin(marginLayoutParams)) - setMultiChoiceItems.getMax(marginLayoutParams)) / 2;
                    if (!z) {
    ...
    public void ensureMeasuredSizeCache(int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(-1342776127, oncanceled);
            onCancelLoad.getMin(-1342776127, oncanceled);
        }
        long[] jArr = this.mMeasuredSizeCache;
        if (jArr == null) {
            if (i < 10) {
