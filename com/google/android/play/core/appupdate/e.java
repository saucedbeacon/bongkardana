...
final class e implements AppUpdateManager {
    ...
    public final Task<Void> completeUpdate() {
        return this.f9546a.b(this.c.getPackageName());
    }

    public final Task<AppUpdateInfo> getAppUpdateInfo() {
        return this.f9546a.a(this.c.getPackageName());
    }
    ...
    public final boolean startUpdateFlowForResult(AppUpdateInfo appUpdateInfo, @AppUpdateType int i, Activity activity, int i2) throws IntentSender.SendIntentException {
        return startUpdateFlowForResult(appUpdateInfo, (IntentSenderForResultStarter) new d(activity), AppUpdateOptions.defaultOptions(i), i2);
    }
    ...
    public final boolean startUpdateFlowForResult(AppUpdateInfo appUpdateInfo, Activity activity, AppUpdateOptions appUpdateOptions, int i) throws IntentSender.SendIntentException {
        return startUpdateFlowForResult(appUpdateInfo, (IntentSenderForResultStarter) new d(activity), appUpdateOptions, i);
    }
