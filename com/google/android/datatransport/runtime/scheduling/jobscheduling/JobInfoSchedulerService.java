...
public class JobInfoSchedulerService extends JobService {
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i2, new getChildFragmentManager(this, jobParameters));
        return true;
    }
    ...
    public /* synthetic */ void lambda$onStartJob$0(JobParameters jobParameters) {
        ...
        if (max != 0) {
            ...
            onCancelLoad.setMax(1786425888, oncanceled);
            onCancelLoad.getMin(1786425888, oncanceled);
        }
