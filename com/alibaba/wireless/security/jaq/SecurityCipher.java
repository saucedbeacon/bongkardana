...
public class SecurityCipher {
    ...
    public String atlasEncryptString(String str) throws JAQException {
        try {
            IAtlasEncryptComponent atlasEncryptComp = SecurityGuardManager.getInstance(this.f10637a).getAtlasEncryptComp();
    ...
    public byte[] decryptBinary(byte[] bArr, String str) throws JAQException {
        try {
            return SecurityGuardManager.getInstance(this.f10637a).getStaticDataEncryptComp().staticBinarySafeDecrypt(16, str, bArr, "0335");
        } catch (SecException e) {
            throw new JAQException(e.getErrorCode());
        }
    }
    ...
    public String decryptString(String str, String str2) throws JAQException {
        try {
            return SecurityGuardManager.getInstance(this.f10637a).getStaticDataEncryptComp().staticSafeDecrypt(16, str2, str, "0335");
        } catch (SecException e) {
            throw new JAQException(e.getErrorCode());
        }
    }
    ...
    public byte[] encryptBinary(byte[] bArr, String str) throws JAQException {
        try {
            return SecurityGuardManager.getInstance(this.f10637a).getStaticDataEncryptComp().staticBinarySafeEncrypt(16, str, bArr, "0335");
        } catch (SecException e) {
            throw new JAQException(e.getErrorCode());
        }
    }
    ...
    public String encryptString(String str, String str2) throws JAQException {
        try {
            return SecurityGuardManager.getInstance(this.f10637a).getStaticDataEncryptComp().staticSafeEncrypt(16, str2, str, "0335");
        } catch (SecException e) {
            throw new JAQException(e.getErrorCode());
        }
    }
