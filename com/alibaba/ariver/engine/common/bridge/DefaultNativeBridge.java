...
import com.alibaba.ariver.engine.common.track.EventTrackerLogUtils;
...
public class DefaultNativeBridge implements NativeBridge {
    ...
    public RVJsStatTrackService c = ((RVJsStatTrackService) RVProxy.get(RVJsStatTrackService.class));
    ...
    public boolean sendToNative(NativeCallContext nativeCallContext, @Nullable SendToNativeCallback sendToNativeCallback) {
        if (!this.f8978a && nativeCallContext != null) {
    ...
    private boolean a(final NativeCallContext nativeCallContext, @Nullable final SendToNativeCallback sendToNativeCallback, boolean z) {
        ...
        BridgeResponseHelper bridgeResponseHelper = new BridgeResponseHelper(new SendToNativeCallback() {
            public void onCallback(JSONObject jSONObject, boolean z) {
                ...
                RVLogger.d(DefaultNativeBridge.TAG, sb2.toString());
        ...
        EventTrackerLogUtils.trackKeyJSAPIInvoke(nativeCallContext);
        if (BridgeDispatcher.getInstance().dispatch(nativeCallContext, bridgeResponseHelper, z)) {
            return true;
        }
        StringBuilder sb3 = new StringBuilder("executeNative but not found Extension!");
        sb3.append(nativeCallContext.getName());
        ...
        if (z) {
            try {
                ...
                StringBuilder sb4 = new StringBuilder("executeNative check failed for legacy call! ");
