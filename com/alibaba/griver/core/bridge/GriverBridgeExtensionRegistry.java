...
public class GriverBridgeExtensionRegistry {

    /* renamed from: a  reason: collision with root package name */
    private final Map<String, ActionMeta> f9186a = new HashMap();
    ...
    public void register(Class<? extends BridgeExtension> cls) {
        ...
        for (ActionMeta next : a2) {
            ...
            this.f9186a.put(next.actionName, next);
        }
        this.b.add(cls);
    }
    ...
    public ActionMeta findActionMeta(String str) {
        ...
        if (this.f9186a.get(str) == null) {
            synchronized (this.f9186a) {
                if (this.f9186a.get(str) == null && this.c.containsKey(str)) {
                ...
                try {
                    ...
                    if (actionFilter != null) {
                        ...
                        if (a2 == null || !a2.contains(value)) {
                            ...
                            if (this.f9186a.containsKey(value)) {
                            ...
                            } else if (this.c.containsKey(value) && !TextUtils.equals(actionMeta.bridgeExtensionClazz.getName(), this.c.get(value).extensionClass)) {
                                StringBuilder sb3 = new StringBuilder("BridgeExtension action [");
                                sb3.append(value);
                                sb3.append("] is not register because of outside JSAPI");
                                RVLogger.w("AriverKernel:BridgeExtensionRegistry", sb3.toString());
                            }
    ...
    public int getRegisteredActionCount() {
        return this.f9186a.size() + this.c.size();
    }
