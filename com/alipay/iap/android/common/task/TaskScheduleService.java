...
public class TaskScheduleService {
        ...
        if (obj != null) {
            try {
                if (obj instanceof TaskPoolExecutor) {
                    ...
                    LoggerWrapper.e(TAG, "shutdownExecutorCommonly, no such type: ".concat(String.valueOf(obj.getClass().getName())));
                }
            } catch (Throwable th) {
    ...
    public ThreadPoolExecutor acquireExecutor(ScheduleType scheduleType) {
        ...
        synchronized (this.executorsMap) {
            ...
            LoggerWrapper.i(TAG, "acquireExecutor: ".concat(String.valueOf(scheduleType)));
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType[] r0 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType = r0
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.IO     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x001d }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.URGENT_DISPLAY     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.URGENT     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.NORMAL     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x003e }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.RPC     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.SYNC     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x0054 }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.MMS_HTTP     // Catch:{ NoSuchFieldError -> 0x0054 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
                r2 = 7
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0054 }
            L_0x0054:
                int[] r0 = $SwitchMap$com$alipay$iap$android$common$task$TaskScheduleService$ScheduleType     // Catch:{ NoSuchFieldError -> 0x0060 }
                com.alipay.iap.android.common.task.TaskScheduleService$ScheduleType r1 = com.alipay.iap.android.common.task.TaskScheduleService.ScheduleType.MMS_DJANGO     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alipay.iap.android.common.task.TaskScheduleService.AnonymousClass1.<clinit>():void");
        }
    }

    private ThreadPoolExecutor createExecutor(PoolCfg poolCfg) {
        if (poolCfg != null) {
            LoggerWrapper.i(TAG, "createExecutor: ".concat(String.valueOf(poolCfg)));
    ...
    public void pause(ScheduleType scheduleType) {
        try {
            ...
            if (scheduleType != ScheduleType.ORDERED) {
                ...
                sb.append(scheduleType);
                sb.append(" failed.");
                LoggerWrapper.e(TAG, sb.toString(), e);
            }
        }
