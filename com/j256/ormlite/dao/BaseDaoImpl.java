...
public abstract class BaseDaoImpl<T, ID> implements Dao<T, ID> {
    ...
    public void initialize() throws SQLException {
        ...
        if (!this.initialized) {
            ...
            if (connectionSource2 != null) {
                ...
                StringBuilder sb = new StringBuilder("connectionSource is getting a null DatabaseType in ");
                sb.append(getClass().getSimpleName());
                throw new IllegalStateException(sb.toString());
            }
            StringBuilder sb2 = new StringBuilder("connectionSource was never set on ");
        ...
        return new CloseableWrappedIterableImpl(new CloseableIterable<T>() {
            ...
            public CloseableIterator<T> closeableIterator() {
                try {
                    ...
                    StringBuilder sb = new StringBuilder("Could not build iterator for ");
        ...
        return new CloseableWrappedIterableImpl(new CloseableIterable<T>() {
            ...
            public CloseableIterator<T> closeableIterator() {
                try {
                    ...
                    StringBuilder sb = new StringBuilder("Could not build prepared-query iterator for ");
                    sb.append(BaseDaoImpl.this.dataClass);
                    throw new IllegalStateException(sb.toString(), e);
                }
            }
    ...
    public long countOf(PreparedQuery<T> preparedQuery) throws SQLException {
        ...
        if (preparedQuery.getType() == StatementBuilder.StatementType.SELECT_LONG) {
            ...
            StringBuilder sb = new StringBuilder("Prepared query is not of type ");
