...
public class RuntimeExceptionDao<T, ID> implements Dao<T, ID> {
    ...
    public T queryForId(ID id2) {
        try {
            ...
            logMessage(e, "queryForId threw exception on: ".concat(String.valueOf(id2)));
    ...
    public int deleteById(ID id2) {
        try {
            ...
            logMessage(e, "deleteById threw exception on: ".concat(String.valueOf(id2)));
            throw new RuntimeException(e);
        }
    }
    ...
    public <UO> GenericRawResults<UO> queryRaw(String str, DatabaseResultsMapper<UO> databaseResultsMapper, String... strArr) {
        ...
        if (length != max) {
            ...
            onCancelLoad.setMax(-2057916405, oncanceled);
            onCancelLoad.getMin(-2057916405, oncanceled);
        }
        try {
    ...
    public boolean objectsEqual(T t, T t2) {
        try {
            ...
            StringBuilder sb = new StringBuilder("objectsEqual threw exception on: ");
            sb.append(t);
            sb.append(" and ");
            sb.append(t2);
    ...
    public void setObjectCache(boolean z) {
        try {
            ...
            StringBuilder sb = new StringBuilder("setObjectCache(");
            sb.append(z);
    ...
    public boolean idExists(ID id2) {
        try {
            ...
            logMessage(e, "idExists threw exception on ".concat(String.valueOf(id2)));
            throw new RuntimeException(e);
        }
    }
    ...
    public void endThreadConnection(DatabaseConnection databaseConnection) {
        try {
            ...
            StringBuilder sb = new StringBuilder("endThreadConnection(");
    ...
    public void setAutoCommit(DatabaseConnection databaseConnection, boolean z) {
        try {
            ...
            StringBuilder sb = new StringBuilder("setAutoCommit(");
            sb.append(databaseConnection);
            sb.append(",");
            sb.append(z);
            sb.append(") threw exception");
    ...
    public boolean isAutoCommit(DatabaseConnection databaseConnection) {
        try {
            ...
            StringBuilder sb = new StringBuilder("isAutoCommit(");
            sb.append(databaseConnection);
            sb.append(") threw exception");
            logMessage(e, sb.toString());
            throw new RuntimeException(e);
