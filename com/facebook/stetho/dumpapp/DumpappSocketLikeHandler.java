...
public class DumpappSocketLikeHandler implements SocketLikeHandler {
    ...
    private void establishConversation(DataInputStream dataInputStream) throws IOException {
        ...
        if (Arrays.equals(PROTOCOL_MAGIC, bArr)) {
            ...
            if (readInt != 1) {
                throw logAndThrowProtocolException("Expected version=1; got=".concat(String.valueOf(readInt)));
            }
            return;
        }
    ...
    private String[] readArgs(Framer framer) throws IOException {
        ...
        synchronized (framer) {
            ...
            if (readFrameType == 33) {
                ...
                throw new DumpappFramingException("Expected enter frame, got: ".concat(String.valueOf(readFrameType)));
            }
        }
        return strArr;
    }
