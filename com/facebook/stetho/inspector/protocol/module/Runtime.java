...
public class Runtime implements ChromeDevtoolsDomain {
    ...
    public void releaseObjectGroup(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        LogUtil.w("Ignoring request to releaseObjectGroup: ".concat(String.valueOf(jSONObject)));
    }
    ...
    public CallFunctionOnResponse callFunctionOn(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) throws JsonRpcException {
        ...
        throw new JsonRpcException(new JsonRpcError(errorCode, sb.toString(), (JSONObject) null));
    }
    ...
    static class Session {
        ...
        public Object getObjectOrThrow(String str) throws JsonRpcException {
            ...
            throw new JsonRpcException(new JsonRpcError(JsonRpcError.ErrorCode.INVALID_REQUEST, "No object found for ".concat(String.valueOf(str)), (JSONObject) null));
        }
        ...
        private List<?> arrayToList(Object obj) {
            ...
            if (!cls.isArray()) {
                throw new IllegalArgumentException("Argument must be an array.  Was ".concat(String.valueOf(cls)));
    ...
    public enum ObjectType {
        ...
        NUMBER("number"),
        BOOLEAN("boolean"),
        SYMBOL(SimplePassword.AnonymousClass1.TYPE_NAME);
    ...
    public enum ObjectSubType {
        ...
        NODE("node"),
        REGEXP("regexp"),
        DATE(AppNode.AnonymousClass2.KEY_DATE),
        MAP("map"),
        SET("set"),
        ITERATOR("iterator"),
        GENERATOR("generator"),
