...
public class DatabaseUtils {
    ...
    public static void dumpCursor(Cursor cursor, StringBuilder sb) {
        StringBuilder sb2 = new StringBuilder(">>>>> Dumping cursor ");
        sb2.append(cursor);
        sb2.append("\n");
    ...
    public static class InsertHelper {
        ...
        /* JADX WARNING: type inference failed for: r3v3, types: [net.sqlcipher.Cursor] */
        ...
        private void buildSQL() throws net.sqlcipher.SQLException {
            /*
                ...
                net.sqlcipher.Cursor r3 = r5.rawQuery((java.lang.String) r6, (java.lang.String[]) r3)     // Catch:{ all -> 0x00ab }
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private synchronized long insertInternal(android.content.ContentValues r3, boolean r4) {
            /*
                r2 = this;
                monitor-enter(r2)
                net.sqlcipher.database.SQLiteStatement r4 = r2.getStatement(r4)     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                r4.clearBindings()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                java.util.Set r3 = r3.valueSet()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                java.util.Iterator r3 = r3.iterator()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
            L_0x0010:
                boolean r0 = r3.hasNext()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                if (r0 == 0) goto L_0x002e
                java.lang.Object r0 = r3.next()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                java.util.Map$Entry r0 = (java.util.Map.Entry) r0     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                java.lang.Object r1 = r0.getKey()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                java.lang.String r1 = (java.lang.String) r1     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                int r1 = r2.getColumnIndex(r1)     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                java.lang.Object r0 = r0.getValue()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                net.sqlcipher.DatabaseUtils.bindObjectToProgram(r4, r1, r0)     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                goto L_0x0010
            L_0x002e:
                long r3 = r4.executeInsert()     // Catch:{ SQLException -> 0x0037, all -> 0x0034 }
                monitor-exit(r2)
                return r3
            L_0x0034:
                r3 = move-exception
