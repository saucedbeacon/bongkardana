...
public class MatrixCursor extends AbstractCursor {
    ...
    private Object get(int i) {
        if (i < 0 || i >= this.columnCount) {
            StringBuilder sb = new StringBuilder("Requested column: ");
            sb.append(i);
    ...
    public void addRow(Object[] objArr) {
        ...
        StringBuilder sb = new StringBuilder("columnNames.length = ");
        sb.append(this.columnCount);
    ...
    public boolean isNull(int i) {
        ...
        if (i != max) {
            ...
            onCancelLoad.setMax(-78915875, oncanceled);
            onCancelLoad.getMin(-78915875, oncanceled);
        }
        return get(i) == null;
    }
}
