...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public void setTintList(ColorStateList colorStateList) {
        ...
        if (this.mDrawableContainerState.mTintList != colorStateList) {
            ...
            RequiresPermission.Read.setMin(this.mCurrDrawable, colorStateList);
        }
    }
    ...
    public void setTintMode(@NonNull PorterDuff.Mode mode) {
        ...
        if (this.mDrawableContainerState.mTintMode != mode) {
            ...
            RequiresPermission.Read.setMin(this.mCurrDrawable, mode);
        }
    }
    ...
    public void setAutoMirrored(boolean z) {
        if (this.mDrawableContainerState.mAutoMirrored != z) {
            ...
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
                RequiresPermission.Read.getMin(drawable, this.mDrawableContainerState.mAutoMirrored);
            }
        }
    }
        ...
        try {
            ...
            if (this.mDrawableContainerState.mHasColorFilter) {
                ...
                if (this.mDrawableContainerState.mHasTintList) {
                    RequiresPermission.Read.setMin(drawable, this.mDrawableContainerState.mTintList);
                }
                if (this.mDrawableContainerState.mHasTintMode) {
                    RequiresPermission.Read.setMin(drawable, this.mDrawableContainerState.mTintMode);
                }
            }
    ...
    static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        int mConstantWidth;
        int mDensity = BlobStatic.MONITOR_IMAGE_WIDTH;
        boolean mDither;
