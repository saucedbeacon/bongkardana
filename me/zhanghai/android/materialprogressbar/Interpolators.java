...
class Interpolators {
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X {
        public static final Interpolator INSTANCE = setSupportProgress.setMax(PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT1_SCALE_X {
        public static final Interpolator INSTANCE = setSupportProgress.setMax(PATH_INDETERMINATE_HORIZONTAL_RECT1_SCALE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X {
        public static final Interpolator INSTANCE = setSupportProgress.setMax(PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X);
    ...
    public static class INDETERMINATE_HORIZONTAL_RECT2_SCALE_X {
        public static final Interpolator INSTANCE = setSupportProgress.setMax(PATH_INDETERMINATE_HORIZONTAL_RECT2_SCALE_X);
    ...
    public static class TRIM_PATH_START {
        public static final Interpolator INSTANCE = setSupportProgress.setMax(PATH_TRIM_PATH_START);
    ...
    public static class TRIM_PATH_END {
        public static final Interpolator INSTANCE = setSupportProgress.setMax(PATH_TRIM_PATH_END);
