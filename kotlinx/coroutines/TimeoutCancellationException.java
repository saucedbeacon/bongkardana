...
public final class TimeoutCancellationException extends CancellationException implements APExpansion.ExpansionForEvent<TimeoutCancellationException> {
    @Nullable
    @JvmField
    public final DictionaryKeys coroutine;

    public TimeoutCancellationException(@NotNull String str, @Nullable DictionaryKeys dictionaryKeys) {
        super(str);
        this.coroutine = dictionaryKeys;
    }

    public TimeoutCancellationException(@NotNull String str) {
        this(str, (DictionaryKeys) null);
    }
