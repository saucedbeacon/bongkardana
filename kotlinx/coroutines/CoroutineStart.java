...
public enum CoroutineStart {
    ...
    public final <T> void invoke(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        Object min;
        int i = APSecuritySdk.setMax[ordinal()];
        if (i == 1) {
            try {
            ...
            try {
                ...
                min = WebSocketClient.getMin(context, (Object) null);
                if (function1 != null) {
                    ...
                    if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        probeCoroutineCreated.resumeWith(Result.m1constructorimpl(invoke));
                        return;
                    }
                    return;
                }
                ...
                probeCoroutineCreated.resumeWith(Result.m1constructorimpl(ResultKt.createFailure(th2)));
            }
        } else if (i != 4) {
    ...
    public final <R, T> void invoke(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, @NotNull Continuation<? super T> continuation) {
        CoroutineContext context;
        Object min;
        int i = APSecuritySdk.getMax[ordinal()];
        if (i == 1) {
            onCloseInitiated.getMin(function2, r, continuation);
        } else if (i == 2) {
            ...
            try {
                ...
                Result.Companion companion2 = Result.Companion;
                probeCoroutineCreated.resumeWith(Result.m1constructorimpl(ResultKt.createFailure(th)));
            }
        } else if (i != 4) {
            throw new NoWhenBranchMatchedException();
        }
