...
import o.isHandShakeComplete;
import o.readRemaining;
...
public final class AndroidDispatcherFactory implements MainDispatcherFactory {
    ...
    @NotNull
    public final isHandShakeComplete createDispatcher(@NotNull List<? extends MainDispatcherFactory> list) {
        return new isHandShakeComplete(readRemaining.setMax(Looper.getMainLooper()));
    }
}
