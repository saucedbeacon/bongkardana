...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    static final class LongTimeMark extends TimeMark {
        ...
        public final double m1512elapsedNowUwyO8pc() {
        ...
        public final TimeMark m1513plusLRDsOJo(double d) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1545plusLRDsOJo(this.offset, d), (DefaultConstructorMarker) null);
        }
    }

    @NotNull
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1566getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
