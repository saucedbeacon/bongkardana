...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    @Nullable
    public final <U, S> Object callRecursive(@NotNull DeepRecursiveFunction<U, S> deepRecursiveFunction, U u, @NotNull Continuation<? super S> continuation) {
        ...
        if (block$kotlin_stdlib != null) {
            ...
            if (block$kotlin_stdlib != function3) {
                ...
                if (continuation != null) {
                    continuation2 = deepRecursiveScopeImpl.crossFunctionCompletion(function3, continuation);
                } else {
                    throw new NullPointerException("null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
                }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r;
            } else if (Result.m3equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
