...
public class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final java.io.File copyTo(@org.jetbrains.annotations.NotNull java.io.File r6, @org.jetbrains.annotations.NotNull java.io.File r7, boolean r8, int r9) {
        ...
        L_0x0053:
            ...
            r6 = r8
            java.io.FileInputStream r6 = (java.io.FileInputStream) r6     // Catch:{ all -> 0x007d }
            java.io.FileOutputStream r0 = new java.io.FileOutputStream     // Catch:{ all -> 0x007d }
            r0.<init>(r7)     // Catch:{ all -> 0x007d }
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch:{ all -> 0x007d }
            r1 = r0
            java.io.FileOutputStream r1 = (java.io.FileOutputStream) r1     // Catch:{ all -> 0x0076 }
            java.io.InputStream r6 = (java.io.InputStream) r6     // Catch:{ all -> 0x0076 }
            java.io.OutputStream r1 = (java.io.OutputStream) r1     // Catch:{ all -> 0x0076 }
            kotlin.io.ByteStreamsKt.copyTo(r6, r1, r9)     // Catch:{ all -> 0x0076 }
            r6 = 0
            kotlin.io.CloseableKt.closeFinally(r0, r6)     // Catch:{ all -> 0x007d }
            kotlin.io.CloseableKt.closeFinally(r8, r6)
        L_0x0075:
            return r7
        L_0x0076:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:33:0x00a1 A[Catch:{ TerminateException -> 0x00e5 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final boolean copyRecursively(@org.jetbrains.annotations.NotNull java.io.File r11, @org.jetbrains.annotations.NotNull java.io.File r12, boolean r13, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.io.OnErrorAction> r14) {
        ...
        L_0x002e:
            return r2
        L_0x002f:
            kotlin.io.FileTreeWalk r0 = kotlin.io.FilesKt.walkTopDown(r11)     // Catch:{ TerminateException -> 0x00e5 }
        ...
        L_0x0042:
            ...
            kotlin.io.OnErrorAction r3 = (kotlin.io.OnErrorAction) r3     // Catch:{ TerminateException -> 0x00e5 }
            kotlin.io.OnErrorAction r4 = kotlin.io.OnErrorAction.TERMINATE     // Catch:{ TerminateException -> 0x00e5 }
            if (r3 != r4) goto L_0x0042
            return r2
        L_0x006b:
            java.lang.String r4 = kotlin.io.FilesKt.toRelativeString(r3, r11)     // Catch:{ TerminateException -> 0x00e5 }
        ...
        L_0x008a:
            ...
            boolean r4 = kotlin.io.FilesKt.deleteRecursively(r5)     // Catch:{ TerminateException -> 0x00e5 }
        ...
        L_0x00bd:
            ...
            r4 = r3
            r6 = r13
            java.io.File r4 = kotlin.io.FilesKt.copyTo$default(r4, r5, r6, r7, r8, r9)     // Catch:{ TerminateException -> 0x00e5 }
    ...
    public static final boolean startsWith(@NotNull File file, @NotNull File file2) {
        ...
        Intrinsics.checkNotNullParameter(file2, H5ResourceHandlerUtil.OTHER);
    ...
    public static final boolean startsWith(@NotNull File file, @NotNull String str) {
        Intrinsics.checkNotNullParameter(file, "$this$startsWith");
        Intrinsics.checkNotNullParameter(str, H5ResourceHandlerUtil.OTHER);
