...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(@org.jetbrains.annotations.NotNull java.io.File r11) {
        /*
            ...
            r1 = r0
            java.io.FileInputStream r1 = (java.io.FileInputStream) r1     // Catch:{ all -> 0x00ad }
            long r2 = r11.length()     // Catch:{ all -> 0x00ad }
            r4 = 2147483647(0x7fffffff, double:1.060997895E-314)
            java.lang.String r6 = "File "
            int r7 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r7 > 0) goto L_0x008c
            int r3 = (int) r2
            byte[] r2 = new byte[r3]     // Catch:{ all -> 0x00ad }
            r4 = 0
            r5 = r3
            r7 = 0
        L_0x0022:
            if (r5 <= 0) goto L_0x002d
            int r8 = r1.read(r2, r7, r5)     // Catch:{ all -> 0x00ad }
        ...
        L_0x002d:
            ...
            byte[] r2 = java.util.Arrays.copyOf(r2, r7)     // Catch:{ all -> 0x00ad }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r9)     // Catch:{ all -> 0x00ad }
            goto L_0x006f
        L_0x003a:
            int r5 = r1.read()     // Catch:{ all -> 0x00ad }
            r7 = -1
            if (r5 != r7) goto L_0x0042
            goto L_0x006f
        L_0x0042:
            kotlin.io.ExposingBufferByteArrayOutputStream r7 = new kotlin.io.ExposingBufferByteArrayOutputStream     // Catch:{ all -> 0x00ad }
            r10 = 8193(0x2001, float:1.1481E-41)
            r7.<init>(r10)     // Catch:{ all -> 0x00ad }
            r7.write(r5)     // Catch:{ all -> 0x00ad }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x00ad }
            r5 = r7
            java.io.OutputStream r5 = (java.io.OutputStream) r5     // Catch:{ all -> 0x00ad }
            r10 = 2
            kotlin.io.ByteStreamsKt.copyTo$default(r1, r5, r4, r10, r8)     // Catch:{ all -> 0x00ad }
            int r1 = r7.size()     // Catch:{ all -> 0x00ad }
            int r1 = r1 + r3
            if (r1 < 0) goto L_0x0073
            byte[] r11 = r7.getBuffer()     // Catch:{ all -> 0x00ad }
            byte[] r1 = java.util.Arrays.copyOf(r2, r1)     // Catch:{ all -> 0x00ad }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r9)     // Catch:{ all -> 0x00ad }
            int r2 = r7.size()     // Catch:{ all -> 0x00ad }
            byte[] r2 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r1, (int) r3, (int) r4, (int) r2)     // Catch:{ all -> 0x00ad }
        L_0x006f:
            kotlin.io.CloseableKt.closeFinally(r0, r8)
            return r2
        L_0x0073:
            java.lang.OutOfMemoryError r1 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x00ad }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ad }
            r2.<init>(r6)     // Catch:{ all -> 0x00ad }
            r2.append(r11)     // Catch:{ all -> 0x00ad }
            java.lang.String r11 = " is too big to fit in memory."
            r2.append(r11)     // Catch:{ all -> 0x00ad }
            java.lang.String r11 = r2.toString()     // Catch:{ all -> 0x00ad }
            r1.<init>(r11)     // Catch:{ all -> 0x00ad }
            java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x00ad }
            throw r1     // Catch:{ all -> 0x00ad }
        L_0x008c:
            java.lang.OutOfMemoryError r1 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x00ad }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ad }
            r4.<init>(r6)     // Catch:{ all -> 0x00ad }
            r4.append(r11)     // Catch:{ all -> 0x00ad }
            java.lang.String r11 = " is too big ("
            r4.append(r11)     // Catch:{ all -> 0x00ad }
            r4.append(r2)     // Catch:{ all -> 0x00ad }
            java.lang.String r11 = " bytes) to fit in memory."
            r4.append(r11)     // Catch:{ all -> 0x00ad }
            java.lang.String r11 = r4.toString()     // Catch:{ all -> 0x00ad }
            r1.<init>(r11)     // Catch:{ all -> 0x00ad }
            java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x00ad }
            throw r1     // Catch:{ all -> 0x00ad }
        L_0x00ad:
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void forEachBlock(@org.jetbrains.annotations.NotNull java.io.File r2, int r3, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super byte[], ? super java.lang.Integer, kotlin.Unit> r4) {
        /*
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0057, code lost:
        if (kotlin.internal.PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0) == false) goto L_0x0059;
     */
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r0, java.nio.charset.Charset r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) {
        ...
        L_0x0006:
            java.lang.String r3 = "$this$useLines"
            ...
            r0 = 0
            r3 = r1
            java.io.BufferedReader r3 = (java.io.BufferedReader) r3     // Catch:{ all -> 0x004d }
            kotlin.sequences.Sequence r3 = kotlin.io.TextStreamsKt.lineSequence(r3)     // Catch:{ all -> 0x004d }
            java.lang.Object r2 = r2.invoke(r3)     // Catch:{ all -> 0x004d }
            kotlin.jvm.internal.InlineMarker.finallyStart(r4)
            boolean r0 = kotlin.internal.PlatformImplementationsKt.apiVersionIsAtLeast(r4, r4, r0)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0052, code lost:
        if (kotlin.internal.PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0) == false) goto L_0x0054;
     */
    ...
    public static final <T> T useLines(@org.jetbrains.annotations.NotNull java.io.File r2, @org.jetbrains.annotations.NotNull java.nio.charset.Charset r3, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r4) {
        /*
            ...
            r0 = 1
            r1 = r3
            java.io.BufferedReader r1 = (java.io.BufferedReader) r1     // Catch:{ all -> 0x0048 }
            kotlin.sequences.Sequence r1 = kotlin.io.TextStreamsKt.lineSequence(r1)     // Catch:{ all -> 0x0048 }
            java.lang.Object r4 = r4.invoke(r1)     // Catch:{ all -> 0x0048 }
            kotlin.jvm.internal.InlineMarker.finallyStart(r0)
            boolean r2 = kotlin.internal.PlatformImplementationsKt.apiVersionIsAtLeast(r0, r0, r2)
