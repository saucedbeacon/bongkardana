...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
        ...
        if (length2 >= 0) {
            ...
            do {
                ...
                if (indexOf >= str.length() || (indexOf = StringsKt.indexOf(charSequence, str2, indexOf + coerceAtLeast, z)) <= 0) {
                    ...
                    String obj = sb.toString();
                    Intrinsics.checkNotNullExpressionValue(obj, "stringBuilder.append(this, i, length).toString()");
                }
                sb.append(charSequence, i, indexOf);
                sb.append(str3);
                i = indexOf + length;
            ...
            Intrinsics.checkNotNullExpressionValue(obj2, "stringBuilder.append(this, i, length).toString()");
            return obj2;
        }
    ...
    public static final String decodeToString(@NotNull byte[] bArr, int i, int i2, boolean z) {
        ...
        Intrinsics.checkNotNullExpressionValue(obj, "decoder.decode(ByteBuffe…- startIndex)).toString()");
        return obj;
    }
    ...
    public static final int compareTo(@NotNull String str, @NotNull String str2, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(str2, H5ResourceHandlerUtil.OTHER);
        if (z) {
