...
final class DanaUpdateManager$Grayscale$Algorithm extends Lambda implements Function1<isBaselineAligned, Unit> {
    final /* synthetic */ DanaUpdateManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    DanaUpdateManager$Grayscale$Algorithm(DanaUpdateManager danaUpdateManager) {
        super(1);
