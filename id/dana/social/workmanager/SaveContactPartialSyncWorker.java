...
public final class SaveContactPartialSyncWorker extends BaseSocialSyncWorker {
    ...
    public SaveContactPartialSyncWorker(@NotNull Context context, @NotNull WorkerParameters workerParameters) {
    ...
    public final void length() {
        ...
        onTextChanged min = ((setBackgroundDrawable.getMin) ((setBackgroundDrawable.getMin) new setBackgroundDrawable.getMin(SaveContactPartialSyncWorker.class).length(BackoffPolicy.EXPONENTIAL, TimeUnit.MINUTES)).setMax(30, timeUnit)).setMin();
        ...
        try {
            ...
            max.setMin("SAVE_CONTACT_PARTIAL_SYNC_KEY", existingWorkPolicy, Collections.singletonList(setbackgrounddrawable));
        } catch (Exception e) {
            try {
