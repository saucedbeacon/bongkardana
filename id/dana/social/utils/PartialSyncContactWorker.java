...
public final class PartialSyncContactWorker extends BaseSocialSyncWorker {
    ...
    public PartialSyncContactWorker(@NotNull Context context, @NotNull WorkerParameters workerParameters) {
    ...
    public final void length() {
        ...
        setButtonStyle.getMin(applicationContext, 1, TimeUnit.SECONDS);
    }
}
