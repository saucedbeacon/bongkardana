...
final class SendMoneyActivity$FastBitmap$CoordinateSystem implements DialogInterface.OnClickListener {
    final /* synthetic */ SendMoneyActivity getMax;
    final /* synthetic */ getCurrX length;

    SendMoneyActivity$FastBitmap$CoordinateSystem(SendMoneyActivity sendMoneyActivity, getCurrX getcurrx) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        if (-1 == i) {
            this.getMax.getBillerX2BPresenter().length(this.length);
