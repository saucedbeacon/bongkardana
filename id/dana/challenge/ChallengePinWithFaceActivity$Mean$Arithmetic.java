...
final class ChallengePinWithFaceActivity$Mean$Arithmetic extends Lambda implements Function1<isBaselineAligned, Unit> {
    final /* synthetic */ ChallengePinWithFaceActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ChallengePinWithFaceActivity$Mean$Arithmetic(ChallengePinWithFaceActivity challengePinWithFaceActivity) {
        super(1);
    ...
    public final void invoke(@NotNull isBaselineAligned isbaselinealigned) {
        ...
        ChallengePinWithFaceActivity.access$closeActivity(this.this$0);
    }
}
