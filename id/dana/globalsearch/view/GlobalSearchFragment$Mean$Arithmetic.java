...
final class GlobalSearchFragment$Mean$Arithmetic implements Ignore.setMin {
    final /* synthetic */ GlobalSearchFragment getMax;

    GlobalSearchFragment$Mean$Arithmetic(GlobalSearchFragment globalSearchFragment) {
        this.getMax = globalSearchFragment;
    }

    public final void length(int i) {
        GlobalSearchFragment.setMin(this.getMax, i);
    }
}
