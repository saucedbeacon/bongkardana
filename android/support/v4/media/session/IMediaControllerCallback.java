        ...
        static class Proxy implements IMediaControllerCallback {
            ...
            public void onEvent(String str, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(1, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onSessionDestroyed() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    this.getMax.transact(2, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat playbackStateCompat) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(3, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onMetadataChanged(MediaMetadataCompat mediaMetadataCompat) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(4, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onQueueChanged(List<MediaSessionCompat.QueueItem> list) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(5, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onQueueTitleChanged(CharSequence charSequence) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(6, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onExtrasChanged(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(7, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo parcelableVolumeInfo) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(8, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onRepeatModeChanged(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    obtain.writeInt(i);
                    this.getMax.transact(9, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onShuffleModeChangedRemoved(boolean z) throws RemoteException {
                ...
                try {
                    ...
                    this.getMax.transact(10, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onCaptioningEnabledChanged(boolean z) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    obtain.writeInt(z ? 1 : 0);
                    this.getMax.transact(11, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onShuffleModeChanged(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    obtain.writeInt(i);
                    this.getMax.transact(12, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onSessionReady() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaControllerCallback");
                    this.getMax.transact(13, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
