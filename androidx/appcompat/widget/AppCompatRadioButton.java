...
public class AppCompatRadioButton extends RadioButton implements getResources, onStart {
    ...
    public AppCompatRadioButton(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, ITrustedWebActivityCallback.Stub.getMin.ICustomTabsCallback$Stub);
    }
