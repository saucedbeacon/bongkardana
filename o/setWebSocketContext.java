...
@JvmInline
public final class setWebSocketContext<E> {
    private final Object getMax;

    public final boolean equals(Object obj) {
        return length(this.getMax, obj);
    }
    ...
    @NotNull
    public static final Object getMax(Object obj, E e) {
        if (getApdidToken.setMax() && !(!(e instanceof List))) {
    ...
    private static boolean length(Object obj, Object obj2) {
        return (obj2 instanceof setWebSocketContext) && Intrinsics.areEqual(obj, ((setWebSocketContext) obj2).getMax);
    }
}
