...
final class submitSerial {
    ...
    public static byte[] getMax(String str) {
        int i;
    ...
    public static String getMin(byte[] bArr) {
        return length(bArr, setMax);
    }

    public static String getMax(byte[] bArr) {
        return length(bArr, setMin);
    }

    private static String length(byte[] bArr, byte[] bArr2) {
