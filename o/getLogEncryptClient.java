...
public final class getLogEncryptClient extends getLogUploadRpcClient {
    private static final char[] getMin = "0123456789ABCDEF".toCharArray();
    private static final char[] setMin = {'+'};
    private final boolean[] getMax;
    private final boolean length;

    public getLogEncryptClient(String str) {
    ...
    public final int setMax(CharSequence charSequence, int i, int i2) {
        while (i < i2) {
    ...
    /* access modifiers changed from: protected */
    public final char[] setMin(int i) {
        boolean[] zArr = this.getMax;
