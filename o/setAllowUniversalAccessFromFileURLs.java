...
public final class setAllowUniversalAccessFromFileURLs extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isFeatureGoalsBalanceEnable = this.featureConfigRepository.isFeatureGoalsBalanceEnable();
        Intrinsics.checkNotNullExpressionValue(isFeatureGoalsBalanceEnable, "featureConfigRepository.…FeatureGoalsBalanceEnable");
