...
public final class onAnimation {
    ...
    private onAnimation(byte[] bArr, int i, int i2) {
        this.buffer = bArr;
        this.position = i;
        this.limit = i + i2;
    }

    static onAnimation newInstance(byte[] bArr) {
        return newInstance(bArr, 0, bArr.length);
    }

    public static onAnimation newInstance(byte[] bArr, int i, int i2) {
        return new onAnimation(bArr, i, i2);
    }
