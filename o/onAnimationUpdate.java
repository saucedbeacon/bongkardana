...
public final class onAnimationUpdate extends RecyclerView.Adapter<GriverH5> {
    @NotNull
    public static final setMax length = new setMax((byte) 0);
    private final PromoSectionModel getMax;
    ...
    public final /* synthetic */ void onBindViewHolder(RecyclerView.valueOf valueof, int i) {
        GriverH5 griverH5 = (GriverH5) valueof;
        Intrinsics.checkNotNullParameter(griverH5, "holder");
        griverH5.setMax(this.getMax);
    }

    public final /* synthetic */ RecyclerView.valueOf onCreateViewHolder(ViewGroup viewGroup, int i) {
        Intrinsics.checkNotNullParameter(viewGroup, "parent");
        return new GriverH5(viewGroup);
    }

    public onAnimationUpdate(@NotNull PromoSectionModel promoSectionModel) {
        Intrinsics.checkNotNullParameter(promoSectionModel, "promoSectionModel");
        this.getMax = promoSectionModel;
    }

    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lid/dana/promocenter/adapter/RegularPromoSectionAdapter$Companion;", "", "()V", "DEFAULT_SIZE", "", "app_productionRelease"}, k = 1, mv = {1, 4, 2})
