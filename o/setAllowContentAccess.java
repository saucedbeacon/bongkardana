...
public final class setAllowContentAccess extends APWebChromeClient<getDefaultZoom, onReceivedIcon> {
    ...
    @NotNull
    public final TitleBarRightButtonView.AnonymousClass1<getDefaultZoom> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        Intrinsics.checkNotNullParameter(onreceivedicon, "params");
        return this.electronicmoneyRepository.getBrizziAccessToken();
    }
}
