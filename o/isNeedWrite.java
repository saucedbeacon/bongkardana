...
class isNeedWrite extends retryRequest<Unit> {
    public isNeedWrite(@NotNull CoroutineContext coroutineContext, boolean z) {
        super(coroutineContext, z);
    }

    /* access modifiers changed from: protected */
    public final boolean length(@NotNull Throwable th) {
        APExpansion.AnonymousClass2.setMin(getContext(), th);
        return true;
    }
}
