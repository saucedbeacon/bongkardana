...
public final class onLocationChanged implements getAdapterPosition<LocationBridgeExtension.AnonymousClass2> {
    private final b.C0007b<handleSave> length;

    private onLocationChanged(b.C0007b<handleSave> bVar) {
        this.length = bVar;
    }

    public static onLocationChanged setMin(b.C0007b<handleSave> bVar) {
        return new onLocationChanged(bVar);
    }

    public final /* synthetic */ Object get() {
        return new setSpeed<getRequestHeaders, showSoftInput>(this.length.get()) {
