...
public final class AppContext implements getAdapterPosition<generateKey> {
    ...
    public AppContext(NetworkModule networkModule, b.C0007b<HttpLoggingInterceptor> bVar, b.C0007b<getCallback> bVar2, b.C0007b<CommonBackPerform> bVar3, b.C0007b<SendToNativeCallback> bVar4, b.C0007b<onHandleWork> bVar5, b.C0007b<translateSingleFrame.length> bVar6, b.C0007b<Draft.CloseHandshakeType> bVar7) {
    ...
    public final generateKey get() {
        return provideOkHttpClient(this.module, this.httpLoggingInterceptorProvider.get(), this.requestHeaderInterceptorProvider.get(), this.networkAvailabilityInterceptorProvider.get(), this.eTagCacheInterceptorProvider.get(), this.flipperOkhttpInterceptorProvider.get(), this.eventListenerFactoryProvider.get(), this.cacheProvider.get());
    }

    public static AppContext create(NetworkModule networkModule, b.C0007b<HttpLoggingInterceptor> bVar, b.C0007b<getCallback> bVar2, b.C0007b<CommonBackPerform> bVar3, b.C0007b<SendToNativeCallback> bVar4, b.C0007b<onHandleWork> bVar5, b.C0007b<translateSingleFrame.length> bVar6, b.C0007b<Draft.CloseHandshakeType> bVar7) {
        return new AppContext(networkModule, bVar, bVar2, bVar3, bVar4, bVar5, bVar6, bVar7);
    }

    public static generateKey provideOkHttpClient(NetworkModule networkModule, HttpLoggingInterceptor httpLoggingInterceptor, getCallback getcallback, CommonBackPerform commonBackPerform, SendToNativeCallback sendToNativeCallback, onHandleWork onhandlework, translateSingleFrame.length length, Draft.CloseHandshakeType closeHandshakeType) {
        generateKey provideOkHttpClient = networkModule.provideOkHttpClient(httpLoggingInterceptor, getcallback, commonBackPerform, sendToNativeCallback, onhandlework, length, closeHandshakeType);
