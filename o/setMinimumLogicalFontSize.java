...
public final class setMinimumLogicalFontSize extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@Nullable onReceivedIcon onreceivedicon) {
        TitleBarRightButtonView.AnonymousClass1<Boolean> isFeatureAnnouncementEnable = this.featureConfigRepository.isFeatureAnnouncementEnable();
        Intrinsics.checkNotNullExpressionValue(isFeatureAnnouncementEnable, "featureConfigRepository.…FeatureAnnouncementEnable");
