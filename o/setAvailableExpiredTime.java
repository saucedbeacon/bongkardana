...
public final class setAvailableExpiredTime extends APWebChromeClient<List<? extends String>, onReceivedIcon> {
    private final setDefaultFontSize featureConfigRepository;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @Inject
    public setAvailableExpiredTime(@NotNull setDefaultFontSize setdefaultfontsize) {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<List<String>> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<List<String>> qrisCrossBorderSupportedCountries = this.featureConfigRepository.getQrisCrossBorderSupportedCountries();
        Intrinsics.checkNotNullExpressionValue(qrisCrossBorderSupportedCountries, "featureConfigRepository.…sBorderSupportedCountries");
