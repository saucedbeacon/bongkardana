...
public final class H5EventDispatchHandler extends parseFailed<Boolean, Unit> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCaseObservable(@Nullable Unit unit) {
        TitleBarRightButtonView.AnonymousClass1<Boolean> isChangeUsernameEnabled = this.featureConfigRepository.isChangeUsernameEnabled();
        Intrinsics.checkNotNullExpressionValue(isChangeUsernameEnabled, "featureConfigRepository.isChangeUsernameEnabled");
