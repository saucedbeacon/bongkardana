...
public final class contact extends isNfcEnable {
    public contact(Context context, NotificationData notificationData) {
    ...
    public final void setMax() {
        ...
        sb.append(String.format("/m/portal/transaction?bizOrderId=%s&isClosable=true", new Object[]{this.length.toFloatRange}));
