...
public class cancelNotification {
    ...
    private static final PlaybackStateCompat.RepeatMode<String, Constructor<? extends View>> sConstructorMap = new PlaybackStateCompat.RepeatMode<>();
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (z4) {
            context2 = addQueueItem.getMax(context2);
        }
        char c = 65535;
        switch (str.hashCode()) {
            case -1946472170:
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT < 15 || ViewCompat.getInterfaceDescriptor(view)) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, sOnClickAttrs);
            String string = obtainStyledAttributes.getString(0);
            if (string != null) {
                view.setOnClickListener(new getMin(view, string));
            }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ITrustedWebActivityCallback.Stub.toIntRange.from, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(ITrustedWebActivityCallback.Stub.toIntRange.to, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(ITrustedWebActivityCallback.Stub.toIntRange.DoNotInline, 0);
        }
        obtainStyledAttributes.recycle();
        if (resourceId != 0) {
            return (!(context instanceof MediaBrowserCompat$MediaItem) || ((MediaBrowserCompat$MediaItem) context).length != resourceId) ? new MediaBrowserCompat$MediaItem(context, resourceId) : context;
        }
        return context;
    }

    static class getMin implements View.OnClickListener {
        private final String getMax;
        private final View getMin;
        private Context length;
        private Method setMax;

        public getMin(@NonNull View view, @NonNull String str) {
            this.getMin = view;
            this.getMax = str;
        }
        ...
        public void onClick(@NonNull View view) {
            if (this.setMax == null) {
                setMin(this.getMin.getContext());
            }
            try {
                this.setMax.invoke(this.length, new Object[]{view});
        ...
        private void setMin(@Nullable Context context) {
            String str;
            Method method;
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.getMax, new Class[]{View.class})) != null) {
                        this.setMax = method;
                        this.length = context;
                        return;
                    }
            ...
            int id2 = this.getMin.getId();
            if (id2 == -1) {
                str = "";
            } else {
                StringBuilder sb = new StringBuilder(" with id '");
                sb.append(this.getMin.getContext().getResources().getResourceEntryName(id2));
                sb.append("'");
                str = sb.toString();
            }
            ...
            sb2.append(this.getMin.getClass());
            sb2.append(str);
