...
final class getBizUniqId extends onPageEnd implements Configuration {
    private final String length;
    private final Throwable setMin;

    public getBizUniqId(@Nullable Throwable th, @Nullable String str) {
        this.setMin = th;
        this.length = str;
    }

    @NotNull
    public final onPageEnd length() {
        return this;
    }
    ...
    private final Void getMax() {
        ...
        if (this.setMin != null) {
            ...
            sb.append(str);
            throw new IllegalStateException(sb.toString(), this.setMin);
        }
        beforeConnect.setMax();
        throw new KotlinNothingValueException();
    }
    ...
    public final /* synthetic */ void getMin(CoroutineContext coroutineContext, Runnable runnable) {
        getMax();
        throw new KotlinNothingValueException();
    }

    public final /* synthetic */ void setMin(long j, cy1 cy1) {
        getMax();
        throw new KotlinNothingValueException();
    }
}
