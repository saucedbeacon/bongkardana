...
public final class getDomStorageEnabled extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isFeatureFeedHighlightEnabled = this.featureConfigRepository.isFeatureFeedHighlightEnabled();
        Intrinsics.checkNotNullExpressionValue(isFeatureFeedHighlightEnabled, "featureConfigRepository.…atureFeedHighlightEnabled");
