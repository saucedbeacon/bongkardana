...
public final class setDEFAULT_ARMA_SPEED extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isFeedNotificationEnable = this.featureConfigRepository.isFeedNotificationEnable();
        Intrinsics.checkNotNullExpressionValue(isFeedNotificationEnable, "featureConfigRepository.isFeedNotificationEnable");
        return isFeedNotificationEnable;
    }
}
