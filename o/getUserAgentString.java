...
public final class getUserAgentString extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isPromoQuestEnable = this.featureConfigRepository.isPromoQuestEnable();
        Intrinsics.checkNotNullExpressionValue(isPromoQuestEnable, "featureConfigRepository.isPromoQuestEnable");
