...
public class performShortcut extends RecyclerView.values {
    ...
    public performShortcut(Context context) {
        this.mDisplayMetrics = context.getResources().getDisplayMetrics();
    }

    public void onTargetFound(View view, RecyclerView$Mean$Arithmetic recyclerView$Mean$Arithmetic, RecyclerView.values.getMin getmin) {
        ...
        if (calculateTimeForDeceleration > 0) {
            ...
            getmin.setMax = -calculateDxToMakeVisible;
            getmin.getMin = -calculateDyToMakeVisible;
    ...
    public void onSeekTargetStep(int i, int i2, RecyclerView$Mean$Arithmetic recyclerView$Mean$Arithmetic, RecyclerView.values.getMin getmin) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        ...
        if (this.mInterimTargetDx == 0 && clampApplyScroll == 0) {
            updateActionForInterimTarget(getmin);
        }
    }
    ...
    /* access modifiers changed from: protected */
    public void updateActionForInterimTarget(RecyclerView.values.getMin getmin) {
        PointF computeScrollVectorForPosition = computeScrollVectorForPosition(getTargetPosition());
        if (computeScrollVectorForPosition == null || (computeScrollVectorForPosition.x == 0.0f && computeScrollVectorForPosition.y == 0.0f)) {
            getmin.length = getTargetPosition();
            stop();
            return;
        }
        ...
        getmin.setMax = (int) (((float) this.mInterimTargetDx) * TARGET_SEEK_EXTRA_SCROLL_RATIO);
        getmin.getMin = (int) (((float) this.mInterimTargetDy) * TARGET_SEEK_EXTRA_SCROLL_RATIO);
        getmin.getMax = (int) (((float) calculateTimeForScrolling) * TARGET_SEEK_EXTRA_SCROLL_RATIO);
        getmin.setMin = linearInterpolator;
        getmin.IsOverlapping = true;
    }
