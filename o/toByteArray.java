...
public final class toByteArray extends APWebChromeClient<Boolean, onReceivedIcon> {
    private final setDefaultFontSize featureConfigRepository;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @Inject
    public toByteArray(@NotNull setDefaultFontSize setdefaultfontsize) {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> onErrorReturnItem = this.featureConfigRepository.isFavoriteServicesEnable().onErrorReturnItem(Boolean.FALSE);
        Intrinsics.checkNotNullExpressionValue(onErrorReturnItem, "featureConfigRepository.….onErrorReturnItem(false)");
