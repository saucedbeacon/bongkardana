...
public final class cancelTimeoutScheduleFuture {
    @NotNull
    private static final Object getMax = new closeBlocking("LIST_EMPTY");
    @NotNull
    private static final Object length = new closeBlocking("CONDITION_FALSE");

    @NotNull
    public static final Object setMax() {
        return length;
    }

    @NotNull
    @PublishedApi
    public static final getWebSocketContext setMax(@NotNull Object obj) {
        getWebSocketContext getwebsocketcontext;
        WSContextConstant wSContextConstant = (WSContextConstant) (!(obj instanceof WSContextConstant) ? null : obj);
        if (wSContextConstant != null && (getwebsocketcontext = wSContextConstant.setMin) != null) {
