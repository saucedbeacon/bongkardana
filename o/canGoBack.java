...
public final class canGoBack extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> sendMoneyFeedConfig = this.featureConfigRepository.getSendMoneyFeedConfig();
        Intrinsics.checkNotNullExpressionValue(sendMoneyFeedConfig, "featureConfigRepository.sendMoneyFeedConfig");
