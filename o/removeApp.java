...
public final class removeApp extends parseFailed<Boolean, Unit> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCaseObservable(@Nullable Unit unit) {
        TitleBarRightButtonView.AnonymousClass1<Boolean> isQrisTcico = this.featureConfigRepository.isQrisTcico();
        Intrinsics.checkNotNullExpressionValue(isQrisTcico, "featureConfigRepository.isQrisTcico");
        return isQrisTcico;
    }
}
