...
public abstract class getLocalSocketAddress<E> extends getWebSocketContext implements isClosed<E> {
    @Nullable
    public Function1<Throwable, Unit> setMin(E e) {
        return null;
    }

    public abstract void setMin(@NotNull batch<?> batch);
