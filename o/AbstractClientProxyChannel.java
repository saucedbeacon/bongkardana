...
public final class AbstractClientProxyChannel {
    @Nullable
    public static final <E> UndeliveredElementException getMax(@NotNull Function1<? super E, Unit> function1, E e, @Nullable UndeliveredElementException undeliveredElementException) {
        try {
            function1.invoke(e);
        } catch (Throwable th) {
    ...
    public static final class getMin extends Lambda implements Function1<Throwable, Unit> {
        ...
        public getMin(Function1 function1, Object obj, CoroutineContext coroutineContext) {
            super(1);
        ...
        public final void invoke(@NotNull Throwable th) {
            ...
            UndeliveredElementException max = AbstractClientProxyChannel.getMax(function1, obj, (UndeliveredElementException) null);
            if (max != null) {
                APExpansion.AnonymousClass2.setMin(coroutineContext, max);
            }
        }
    }
}
