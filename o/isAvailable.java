...
public final class isAvailable implements setNeedShowFail {
    private final PrepareException.AnonymousClass1 length;
    private final AutoCompleteBankModule setMax;

    public /* synthetic */ isAvailable(AutoCompleteBankModule autoCompleteBankModule, PrepareException.AnonymousClass1 r2, byte b) {
        this(autoCompleteBankModule, r2);
    }

    private isAvailable(AutoCompleteBankModule autoCompleteBankModule, PrepareException.AnonymousClass1 r2) {
        this.length = r2;
        this.setMax = autoCompleteBankModule;
    }

    public static final class setMin {
        public PrepareException.AnonymousClass1 getMax;
        public AutoCompleteBankModule setMin;
    ...
    public final void getMax(AutoCompleteBankView autoCompleteBankView) {
        AutoCompleteBankModule autoCompleteBankModule = this.setMax;
        Context max = this.length.getMax();
        if (max != null) {
            Context context = max;
            SaveImageToAlbumBridgeExtension saveImageToAlbumBridgeExtension = new SaveImageToAlbumBridgeExtension();
            ...
            if (length2 != null) {
                ...
                if (min != null) {
                    ...
                    if (onNavigationEvent != null) {
                        GriverPhotoSelectActivity.AnonymousClass6.getMin(autoCompleteBankView, BigDecimalCodec.length(autoCompleteBankModule, new onGridChecked(context, saveImageToAlbumBridgeExtension, new BleGattService(appxloadfailed, getscheme, onNavigationEvent), cast.length(this.setMax), new BucketAdapter(new setSpeed<stopBleScan, CurrencyAmountModel>() {
