...
public class setNodeId extends BaseRpcResult {
    private String allowedContent;
    private List<generateNodeId> cdpContents;
    ...
    public List<generateNodeId> getCdpContents() {
        return this.cdpContents;
    }

    public void setCdpContents(List<generateNodeId> list) {
