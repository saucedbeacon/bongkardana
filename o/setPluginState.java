...
public final class setPluginState extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isNearbyMeMapViewEnable = this.featureConfigRepository.isNearbyMeMapViewEnable();
        Intrinsics.checkNotNullExpressionValue(isNearbyMeMapViewEnable, "featureConfigRepository.isNearbyMeMapViewEnable");
