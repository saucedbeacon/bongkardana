...
public interface getOfflineMode {
    @NotNull
    TitleBarRightButtonView.CornerMarkingUIController.AnonymousClass1<setNbUrl> createTicket(@NotNull String str, @NotNull isNeedShowFail isneedshowfail);
}
