...
public final class hasSupportDividerBeforeChildAt implements TypeEvaluator {
    private static final hasSupportDividerBeforeChildAt setMin = new hasSupportDividerBeforeChildAt();

    public static hasSupportDividerBeforeChildAt getMax() {
        return setMin;
    }
