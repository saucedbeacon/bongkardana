...
public final class setCacheMode extends APWebChromeClient<Boolean, onReceivedIcon> {
    private final setDefaultFontSize featureConfigRepository;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @Inject
    public setCacheMode(@NotNull setDefaultFontSize setdefaultfontsize) {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@Nullable onReceivedIcon onreceivedicon) {
        TitleBarRightButtonView.AnonymousClass1<Boolean> checkIsResendWhatsAppEnable = this.featureConfigRepository.checkIsResendWhatsAppEnable();
        Intrinsics.checkNotNullExpressionValue(checkIsResendWhatsAppEnable, "featureConfigRepository.…kIsResendWhatsAppEnable()");
