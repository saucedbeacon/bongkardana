...
public final class sendHandshake {
    @Nullable
    public static final <T, R> Object length(@NotNull WebSocketCallback<? super T> webSocketCallback, R r, @NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        Object obj;
        webSocketCallback.setMax();
        try {
            Continuation continuation = webSocketCallback;
            if (function2 != null) {
                obj = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).invoke(r, continuation);
                if (obj == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    return IntrinsicsKt.getCOROUTINE_SUSPENDED();
                }
                Object a_ = webSocketCallback.a_(obj);
                if (a_ == onPage.getMax) {
                    return IntrinsicsKt.getCOROUTINE_SUSPENDED();
                }
                if (!(a_ instanceof APExpansion)) {
                    return onPage.getMin(a_);
                }
                Throwable th = ((APExpansion) a_).setMax;
                Continuation<T> continuation2 = webSocketCallback.IsOverlapping;
                if (getApdidToken.length() && (continuation2 instanceof CoroutineStackFrame)) {
                    th = WebSocketCallbackAdapter.length(th, (CoroutineStackFrame) continuation2);
                }
                throw th;
            }
            throw new NullPointerException("null cannot be cast to non-null type (R, kotlin.coroutines.Continuation<T>) -> kotlin.Any?");
        } catch (Throwable th2) {
            obj = new APExpansion(th2);
        }
    }
}
