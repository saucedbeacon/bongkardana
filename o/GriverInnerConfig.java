...
public final class GriverInnerConfig extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isHomeRevampEnable = this.featureConfigRepository.isHomeRevampEnable();
        Intrinsics.checkNotNullExpressionValue(isHomeRevampEnable, "featureConfigRepository.isHomeRevampEnable");
        return isHomeRevampEnable;
    }
}
