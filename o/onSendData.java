...
public final class onSendData extends APWebChromeClient<Set<? extends String>, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Set<String>> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Set<String>> featureSkipButtonMerchantList = this.featureConfigRepository.getFeatureSkipButtonMerchantList();
        Intrinsics.checkNotNullExpressionValue(featureSkipButtonMerchantList, "featureConfigRepository.…ureSkipButtonMerchantList");
