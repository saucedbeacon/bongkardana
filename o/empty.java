...
public final class empty extends APWebChromeClient<Boolean, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<Boolean> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<Boolean> isFeedCommentEnable = this.featureConfigRepository.isFeedCommentEnable();
        Intrinsics.checkNotNullExpressionValue(isFeedCommentEnable, "featureConfigRepository.isFeedCommentEnable");
        return isFeedCommentEnable;
    }
}
