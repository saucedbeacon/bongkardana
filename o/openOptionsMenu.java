...
public final class openOptionsMenu {
    public static void getMin(@NonNull ListView listView, int i) {
        View childAt;
    ...
    public static boolean setMin(@NonNull ListView listView, int i) {
        if (Build.VERSION.SDK_INT >= 19) {
