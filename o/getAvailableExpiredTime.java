...
public final class getAvailableExpiredTime extends APWebChromeClient<setConfigUnits, String> {
    private final setDefaultFontSize featureConfigRepository;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @Inject
    public getAvailableExpiredTime(@NotNull setDefaultFontSize setdefaultfontsize) {
    ...
    @NotNull
    public final TitleBarRightButtonView.AnonymousClass1<setConfigUnits> buildUseCase(@NotNull String str) {
        Intrinsics.checkNotNullParameter(str, "params");
        TitleBarRightButtonView.AnonymousClass1<setConfigUnits> qrisCrossBorderContent = this.featureConfigRepository.getQrisCrossBorderContent(str);
        Intrinsics.checkNotNullExpressionValue(qrisCrossBorderContent, "featureConfigRepository.…rossBorderContent(params)");
