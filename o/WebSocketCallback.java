...
public class WebSocketCallback<T> extends retryRequest<T> implements CoroutineStackFrame {
    @NotNull
    @JvmField
    public final Continuation<T> IsOverlapping;
    ...
    public WebSocketCallback(@NotNull CoroutineContext coroutineContext, @NotNull Continuation<? super T> continuation) {
        super(coroutineContext, true);
        this.IsOverlapping = continuation;
    }

    @Nullable
    public final CoroutineStackFrame getCallerFrame() {
        Continuation<T> continuation = this.IsOverlapping;
    ...
    @Nullable
    public final DictionaryKeys invoke() {
        return (DictionaryKeys) this.setMin.get(DictionaryKeys.getMax);
    }

    public void setMax(@Nullable Object obj) {
        onClose.getMax(IntrinsicsKt.intercepted(this.IsOverlapping), getDynData.setMin(obj, this.IsOverlapping));
    }

    public void getMin(@Nullable Object obj) {
        Continuation<T> continuation = this.IsOverlapping;
        continuation.resumeWith(getDynData.setMin(obj, continuation));
    }
}
