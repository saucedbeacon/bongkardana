...
public final class KitUtils extends APWebChromeClient<List<? extends String>, onReceivedIcon> {
    private final setDefaultFontSize featureConfigRepository;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    @Inject
    public KitUtils(@NotNull setDefaultFontSize setdefaultfontsize) {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<List<String>> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<List<String>> whitelistedSubMerchantId = this.featureConfigRepository.getWhitelistedSubMerchantId();
        Intrinsics.checkNotNullExpressionValue(whitelistedSubMerchantId, "featureConfigRepository.whitelistedSubMerchantId");
