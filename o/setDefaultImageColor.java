...
public final class setDefaultImageColor {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList36.add(CountryCode.JAPAN);
        ...
        arrayList48.add("MA");
        arrayList48.add("EH");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_STA_STORE_LOW_VERSION_DATA_FILE), arrayList48);
        ...
        arrayList52.add("GM");
        hashMap.put(Integer.valueOf(WheelView.DIVIDER_ALPHA), arrayList52);
        ...
        arrayList56.add(cornerRadius.GN_NETWORK_INFO_NAME);
        ...
        arrayList105.add("GL");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_STA_STORE_UNKNOWN_ERROR), arrayList105);
        ...
        arrayList135.add("LI");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_DYN_ENC_BASE64_DECODE_FAILED), arrayList135);
        ...
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_DYN_STORE_GET_DATA_FILE_KEY_FAILED), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_DYN_STORE_GET_ENCRYPT_KEY_FAILED), arrayList141);
        ...
        arrayList144.add("PM");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_DYN_STORE_DDPEX_KEY_VALUE_NOT_EXSIT), arrayList144);
        ...
        arrayList155.add("CW");
        arrayList155.add("BQ");
        hashMap.put(Integer.valueOf(SecExceptionCode.SEC_ERROR_DYN_STORE_UNKNOWN_ERROR), arrayList155);
