...
public final class freeMemory extends APWebChromeClient<String, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<String> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        TitleBarRightButtonView.AnonymousClass1<String> tnCReferralMissionConfig = this.featureConfigRepository.getTnCReferralMissionConfig();
        Intrinsics.checkNotNullExpressionValue(tnCReferralMissionConfig, "featureConfigRepository.tnCReferralMissionConfig");
