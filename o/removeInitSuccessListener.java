...
public final class removeInitSuccessListener extends APWebChromeClient<String, onReceivedIcon> {
    ...
    public final TitleBarRightButtonView.AnonymousClass1<String> buildUseCase(@NotNull onReceivedIcon onreceivedicon) {
        ...
        return this.globalSearchRepository.getPopularSearchPlaceholder();
    }
}
