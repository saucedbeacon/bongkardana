...
public final class byteArrayToHexString extends isNfcEnable {
    public byteArrayToHexString(Context context, NotificationData notificationData) {
    ...
    public final void setMax() {
        ...
        sb.append(String.format("/m/notifications/detail?spaceCode=%s&isClosable=true", new Object[]{this.length.toFloatRange}));
