...
public final class onWebsocketError<T> implements onWebsocketPong<T> {
    private final getReadyState<T> getMin;

    public onWebsocketError(@NotNull getReadyState<? super T> getreadystate) {
        this.getMin = getreadystate;
    }

    @Nullable
    public final Object emit(T t, @NotNull Continuation<? super Unit> continuation) {
        Object min = this.getMin.getMin(t, continuation);
