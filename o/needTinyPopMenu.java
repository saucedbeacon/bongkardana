...
public final class needTinyPopMenu<T> extends onLoadMoreStateChanged<T, T> {
    final getOptionMenu<? extends T> getMax;

    public needTinyPopMenu(TitleBarRightButtonView.AnonymousClass1<T> r1, getOptionMenu<? extends T> getoptionmenu) {
        super(r1);
        this.getMax = getoptionmenu;
    }
    ...
    public final void subscribeActual(GriverProgressBar<? super T> griverProgressBar) {
        ...
        this.getMax.getMax(getmin.otherObserver);
    }
    ...
    static final class getMin<T> extends AtomicInteger implements GriverProgressBar<T>, GriverProgressBar.UpdateRunnable {
        ...
        static final class setMax<T> extends AtomicReference<GriverProgressBar.UpdateRunnable> implements setOptionMenuIcon<T> {
            private static final long serialVersionUID = -2935427570954647017L;
            final getMin<T> parent;

            setMax(getMin<T> getmin) {
                this.parent = getmin;
            }
