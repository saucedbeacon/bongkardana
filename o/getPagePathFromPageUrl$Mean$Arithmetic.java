...
class getPagePathFromPageUrl$Mean$Arithmetic implements b.C0007b<toUuidString> {
    private final PrepareException.AnonymousClass1 getMin;

    getPagePathFromPageUrl$Mean$Arithmetic(PrepareException.AnonymousClass1 r1) {
        this.getMin = r1;
    }
